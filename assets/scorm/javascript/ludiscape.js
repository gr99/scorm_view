...
dimensionneCadres();
var t=setTimeout("resizeApp()",2500);}
...
var bullecss="bullewhite";if(obj.boite=="bbullewhite"
||obj.boite=="bcbullewhite"
||obj.boite=="bdbullewhite"){
var cssPlus="";if(obj.css){
cssPlus=obj.css;
}
var h='<div style="display:none;position:absolute;z-index:' + nind + ';' + cssPlus + '" ';
h=h + ' id="bbullewhite' + obj.id + '" unselectable="on" ' ;
h=h + ' class="unselectable bbullewhite' + obj.id + ' alterbloc' + obj.id + '" >';
h=h + '</div>';
if(obj.boite=="bbullewhite"){
h=h + '<img style="position:absolute;z-index:' + nind + ';" ';
h=h + ' src="' + obj.contenu4 + '" ';
h=h + ' id="linkbbullewhite' + obj.id + '" unselectable="on" ' ;
h=h + ' class="unselectable linkbbullewhite' + obj.id + ' alterbloc' + obj.id + '" />';
}
return h;
}
...
h=h + ' src="' + obj.contenu4 + '" ';
h=h + ' id="clouding' + obj.id + '" unselectable="on" ' ;
h=h + ' class="clouding' + obj.id + ' alterbloc' + obj.id + '" />';
h=h + '<img style="position:absolute;z-index:' + nind + ';" ';
h=h + ' src="' + obj.contenu6 + '" ';
h=h + ' id="linkclouding' + obj.id + '" unselectable="on" ' ;
h=h + ' class="unselectable linkbbullewhite' + obj.id + ' alterbloc' + obj.id + '" />';
return h;
}
...
if(obj.boite=="clouding"){
var exb=parseInt(obj.x * zoom);var eyb=parseInt(obj.y * zoom);var wbb=parseInt(obj.w * zoom);var hbb=parseInt(obj.h * zoom);var bbu=$("#clouding" + obj.id);
bbu.css("width", wbb + "px").css("height", hbb + "px");
bbu.css("left", exb + "px").css("top", eyb + "px");
bbu.fadeIn();
var eachElement=obj.contenu5.split(';');var bexb=parseInt(parseInt(eachElement[0]) * zoom);var beyb=parseInt(parseInt(eachElement[1]) * zoom);var bwbb=parseInt(parseInt(eachElement[2]) * zoom);var bhbb=parseInt(parseInt(eachElement[3]) * zoom);var linkclouding=$("#linkclouding" + obj.id);
linkclouding.css("left", bexb + "px").css("top", beyb + "px");
linkclouding.css("width", bwbb + "px").css("height", bhbb + "px");
}
if(obj.boite=="bdbullewhite"||obj.boite=="bdbulleTitle"){
var exb=parseInt(parseInt(obj.x- 5) * zoom);var eyb=parseInt(parseInt(obj.y - 5) * zoom);var wbb=parseInt(parseInt(obj.w + 10) * zoom);
var hbb=parseInt(parseInt(obj.h + 10) * zoom);
...
bbu.css("left", exb + "px").css("top", eyb + "px");
bbu.fadeIn();
var eachElement=obj.contenu5.split(';');var bexb=parseInt(parseInt(eachElement[0]) * zoom);var beyb=parseInt(parseInt(eachElement[1]) * zoom);var bwbb=parseInt(parseInt(eachElement[2]) * zoom);var bhbb=parseInt(parseInt(eachElement[2]) * zoom);var bbulink=$("#linkbbullewhite" + obj.id);
bbulink.css("border-radius","10px");
bbulink.css("width", bwbb + "px").css("height", bhbb + "px");
bbulink.css("left", bexb + "px").css("top", beyb + "px");
return true;
}
var e_x=parseInt(obj.x * zoom);var e_y=parseInt(obj.y * zoom);var wb=parseInt(obj.w * zoom);var hb=parseInt(obj.h * zoom);var dec=10 * zoom;$("#bulle0_" + obj.id).css("width", (wb /1.5) + "px").css("height", (hb- dec) + "px");
...
var h="";h=h + '<div style="display:none;color:' + color + ';position:absolute;overflow:auto;' +  obj.cssadd + '" class="unselectable haveflou unselectable bloc' + obj.id + '" unselectable="on" >';
h=h + obj.text;
h=h + '</div>';
...
var eventCatchScript=false;function installfx(obj,act){
...
h=h + 'position:absolute;left:-5px;width:2px;" >';
h=h + '</div>';
if(obj.data==0){
...
ind=5;
var fctMam='$(".topslideobject' + obj.id +'").css("z-index",' + obj.ind + ');';
setTimeout(fctMam,700);
}
var he=convertToPercentY(obj.h);h='<div class="mat-shadows-a noslideobject topslideobject' +  obj.id + '" ' ;
...
h ='<div id="bloc' +  obj.id + '" ';
h += ' class="mat-shadows-a bloc' +  obj.id + '" ';
...
var col=obj.selectcolor;h='<button id="bloc' + obj.id + '" style="background-color:' + col +  ';" ';
...
h ='<div id="bloc' +  obj.id + '" class="flipcard-container bloc' +  obj.id + '" onClick="this.classList.toggle(\'flipcard-hover\');flipcardHackIE(' +  obj.id + ')">';
h += '<div class="flipcard-flipper flipcardflipper' +  obj.id + '">';
h += '<div class="flipcard-front flipcard-question flipcardfront' +  obj.id + '" >';
h += '';
h += '</div><div hie=0 class="flipcard-back mat-shadows-a flipcardback' +  obj.id + '">';
h += '<table class="flipcardtable' +  obj.id + '" ><tr><td>';
h += 'test';
h += '</td></tr></table>';
h += '</div></div></div>';
$("#main").append(h);
...
function upBI(i){
var wb=parseInt(CObjets[i].w * zoom);var hb=parseInt(CObjets[i].h * zoom);var wb_max=parseInt(wb * 1.2);var hb_max=parseInt(hb * 1.2);var dec_x=parseInt((wb_max - wb) / 2 );var dec_y=parseInt((hb_max - hb) / 2 );/*$('.bloc' + i).css("width",wb_max + 'px').css("height",hb_max + 'px');
$('.bloc' + i).css("margin-left", '-' + dec_x + 'px').css( "margin-top" , '-' + dec_y + 'px');*/
$('.bloc' + i).stop().animate({width :wb_max + 'px',height :hb_max + 'px',marginLeft :  '-' + dec_x + 'px',marginTop :  '-' + dec_y + 'px' } , 500);
/*}, function(){
$(this).stop().animate({width : wb + 'px',height : hb + 'px',marginLeft : '0px',marginTop : '0px' } , 500);
});*/
}
function doBI(i){
var wb=parseInt(CObjets[i].w * zoom);var hb=parseInt(CObjets[i].h * zoom);$('.bloc' + i).stop().animate({width : wb + 'px',height : hb + 'px',marginLeft : '0px',marginTop : '0px' } , 500);
}
function upBL(i){
...
var iwe=parseInt(parseInt(obj.w * 0.9) * zoom);var ihe=parseInt(parseInt(obj.h * 0.8) * zoom);$('#legend' + obj.id ).css("width", parseInt(parseInt(parseInt(obj.w * 0.80) * zoom) - 60) + "px");
...
pointSlide(obj.id);
var iwe=parseInt(parseInt(obj.w) * zoom);var ihe=parseInt(parseInt(obj.h) * zoom);var ratioH=obj.h/200;var vH=parseInt(71*ratioH);var ratioW=obj.w/400;var vW=parseInt(61*ratioW);$("#ombreslide" + obj.id ).css("position",'absolute');
$("#ombreslide" + obj.id ).css("top",parseInt(parseInt(obj.y - parseInt(vH/2)) * zoom) + 'px');
$("#ombreslide" + obj.id ).css("height",parseInt(parseInt(obj.h + vH) * zoom) + 'px');
$("#ombreslide" + obj.id ).css("left",parseInt(parseInt(obj.x -parseInt(vW/2)) * zoom) + 'px');
$("#ombreslide" + obj.id ).css("width" ,parseInt(parseInt(obj.w + vW) * zoom) + 'px');
...
$(idIm).css("top",parseInt(parseInt(obj.y * zoom) + parseInt(ihe/2) - 28) + 'px');
var ec=0 ;var hauteurF=parseInt(720 * zoom);if(hauteurF<700){ec=7;}
if(hauteurF<450){ec=15;}
$("#slidebl" + obj.id ).css("left" ,parseInt(obj.x * zoom) - (36 - ec) + 'px');
$("#slideb2" + obj.id ).css("left" ,parseInt(parseInt(obj.x + obj.w) * zoom) - (3 + ec) + 'px');
...
var parsed=[];parsed=obj.src.split(";");
var iwe=parseInt(parseInt(obj.w) * zoom);actual=actual + incr;
...
var obj=CObjets[id];var actual=parseInt(document.getElementById("numcont" + id).innerHTML);
var parsed=[];parsed=obj.src.split(";");
var iwe=parseInt(parseInt(obj.w) * zoom);actual=parseInt(actual + parseInt(incr));
if(parsed[actual]==''){actual=0;}
...
h=h + ' id="bloc' + obj.id + '" class="hero' + obj.id + '" ';
h=h + ' src="' + obj.text + '" ';
h=h + ' />';
objectifherox=obj.x;
objectifheroy=obj.y;
...
h=h + ' id="collide' + obj.id + '" class="collide' + obj.id + '" ';
h=h + ' src="' + obj.text + '" ';
h=h + ' />';
}
...
h=h + ' id="zoneaction' + obj.id + '" class="bloc' + obj.id + ' zoneaction' + obj.id + '" ';
h=h + ' src="' + obj.text + '" ';
h=h + ' />';
h=h + '<a ';
if(istablet()){
h=h +  ' href="javascript:return false" ';
}else{
h=h +  ' href="#" ';
}
h=h + ' id="bloc' + obj.id + '" class="haveflou unselectable bloc' + obj.id + ' ' +  obj.idscript + '" ';
h=h + ' style="z-index:4;background-image:url(\'fx/transparent.png\');cursor:pointer;" ';
h=h + ' ></a>';
}
...
LUDIlifeheight= parseInt(obj.h);
LUDIlifegameover=parseInt(obj.src);
h=h + '<div style="border:gray 0px solid;display:none;" ';
h=h + ' id="table' + obj.id + '" unselectable="on" ';
h=h + ' class="unselectable bloc' + obj.id + '" ';
h=h + ' >';
LUDIlifeTotal=parseInt(obj.data);
var srcImg=obj.text;if(obj.contenu2!=""){
srcImg='images/' + obj.contenu2;
}
for(var i=0;i<LUDIlifeTotal;i++)
{
if(i<LUDIlife){
h=h + '<img style="float:left;height:100%;" ';
h=h + ' id="gamelife' + i + '" class="gamelife' + i + '" ';
h=h + ' src="' + srcImg + '" ';
h=h + ' />';
}else{
h=h + '<img style="float:left;height:100%;display:none;" ';
h=h + ' id="gamelife' + i + '" class="gamelife' + i + '" ';
h=h + ' src="' + srcImg + '" ';
h=h + ' />';
}
...
var ex=parseInt(obj.x * zoom);var ey=parseInt(obj.y * zoom);var ew=parseInt(obj.w * zoom);var eh=parseInt(obj.h * zoom);var hero_ex=ex - (ew/2);var hero_ey=ey - eh;if(obj.type=='gamehero'){
...
var ex=parseInt(obj.x * zoom);var ey=parseInt(obj.y * zoom);var ew=parseInt(obj.w * zoom);var eh=parseInt(obj.h * zoom);if(obj.type=='gamecollide'){
...
for(var i=0; i < CObjets_count; i++){
var CtrObj=CObjets[i];var ex=parseInt(CtrObj.x);var ey=parseInt(CtrObj.y);var ew=parseInt(CtrObj.w);var eh=parseInt(CtrObj.h);var CtrType=CtrObj.type;if(CtrType=='gamecollide'){
...
CtrObj.option=1;
if(CtrObj.url!=''){
var HeroCtrObj=trouveHero();CtrObj.x=-1000;
CtrObj.y=-1000;
...
if(hx>ex&&hx<parseInt(ex+ew)){
if(hy>ey&&hy<parseInt(ey+eh)){
var HeroCtrObj=trouveHero();CtrObj.y=-1000;
CtrObj.x=-1000;
objectifherox=HeroCtrObj.x;
objectifheroy=HeroCtrObj.y + 3;
...
var idaction ='';function clickAction(){
...
var ex=parseInt(parseInt(xcoord - Ecran.offsetLeft) /zoom);var ey=parseInt(parseInt(ycoord - Ecran.offsetTop ) /zoom);objectifherox=ex;
objectifheroy=ey;
var angleHero=getAngle(objectifherox,objectifheroy,Vobj.x,Vobj.y);var angleDegrees=angleHero *  (180 /Math.PI) ;var imgsrc=($('.hero' + Vobj.id ).attr("src"));
if(objectifherox>Vobj.x){
...
var r=0;if(ctrx>parseInt(ob.x)){
r=r + 1 ;
}
if(ctry>parseInt(ob.y)){
r=r + 1 ;
}
if(ctrx<parseInt(ob.x + ob.w)){
r=r + 1 ;
}
if(ctry<parseInt(ob.y + ob.h)){
r=r + 1 ;
}
if(r==4){
return true;
...
var distx=distancepyta(objectifherox,Vobj.y,Vobj.x,Vobj.y);if(distx>5){
angleHero=getAngle(Vobj.x,Vobj.y,objectifherox,Vobj.y);
}else{
angleHero=getAngle(Vobj.x,Vobj.y,objectifherox,objectifheroy);
}
}else{
angleHero=getAngle(Vobj.x,Vobj.y,objectifherox,objectifheroy);
}
...
var dist=distancepyta(objectifherox,objectifheroy,Vobj.x,Vobj.y);var deplace=parseInt(parseInt(Vobj.border ) * zoom)* (interval / 80);if(dist>5){
var evolx=parseFloat(Vobj.x) +  ((deplace) * Math.cos(angleHero));
var evoly=parseFloat(Vobj.y);var oneColl=false;if(haveCollideObjects(evolx,evoly)==true){
evolx=parseFloat(Vobj.x);
evoly=parseFloat(Vobj.y) + ((deplace) * Math.sin(angleHero));
}else{
evoly=parseFloat(Vobj.y) + ((deplace) * Math.sin(angleHero));
}
...
objectifherox=Vobj.x;
objectifheroy=Vobj.y;
}
zoomGame(Vobj);
...
var Vobj=trouveHero();var dist=distancepyta(objectifherox,objectifheroy,Vobj.x,Vobj.y);if(dist<5){
...
obj.border=0;
h='<img style="position:absolute;z-index:2;" ';
h=h + ' id="bloc' + obj.idstr + '" class="herotarget' + obj.idstr + '" ';
var tobjx=obj.x;var tobjy=obj.y;var lengthPts=1;if(obj.de==0){
...
if(lengthPts==1){
var angleHero=getAngle(obj.x,obj.y,tobjx,tobjy);var angleDegrees=angleHero *  (180 /Math.PI) ;if(angleDegrees>-45&&angleDegrees<45){
h += ' src="' + obj.contenu4 + '" ';
}else{
h += ' src="' + obj.text + '" ';
}
...
h='<img style="position:absolute;z-index:2;" ';
h=h + ' name="' + obj.id + '" id="bloc' + obj.id + '" class="gameheroselect bloc' + obj.id + '" ';
h=h + ' src="' + obj.text + '" ';
h=h + ' />';
Ecran.innerHTML=Ecran.innerHTML + h;
...
var ex=parseInt(obj.x * zoom);var ey=parseInt(obj.y * zoom);var ew=parseInt(obj.w * zoom);var eh=parseInt(obj.h * zoom);var hero_ex=ex - (ew/2);var hero_ey=ey - (eh/2);$(".herotarget" + obj.idstr).css("left",hero_ex + 'px').css("top",hero_ey + 'px');
$(".herotarget" + obj.idstr).css("width",ew + 'px').css("height",eh + 'px');
}
}
function haveCollideObjectsTarget(hx,hy,idstr){
for(var i=0; i < CObjets_count; i++){
var CtrObj=CObjets[i];var ex=parseInt(CtrObj.x);var ey=parseInt(CtrObj.y);var ew=parseInt(CtrObj.w);var eh=parseInt(CtrObj.h);var CtrType=CtrObj.type;if(CtrType=='gamezoneaction'){
var act='';if(CtrObj.url!=''){
if(CtrObj.url.indexOf("link:")!=-1){
var ur=CtrObj.url.replace('link:','');act='window.location.href=\'' + ur + '\'; ';
}else{
...
var parsedPt=[];parsedPt=parsedPoints[parseInt(obj.border)].split(";");
var wb=parseInt(obj.w/2);var hb=parseInt(obj.h/2);var xm=parseInt(parsedPt[0]);var ym=parseInt(parsedPt[1]);if(xm>(largEcranWidth-3)){
xm=largEcranWidth + parseInt(obj.w/1.5);
}
if(xm<3){
xm=parseInt(obj.w/1.5) * -1;
}
...
var angleHero=0;try{angleHero=getAngle(obj.x,obj.y,obj.objx,obj.objy);
}catch(err){}
var dist=distancepyta(obj.objx,obj.objy,obj.x,obj.y);var deplace=parseInt(8 * zoom);var distCtr=parseInt(parseInt(obj.align) + 2);
if(distCtr<5){distCtr=5;}
if(dist>distCtr){
var deplace=parseInt(parseInt(obj.align) * zoom);var evolx=parseFloat(obj.x) + ((deplace) * Math.cos(angleHero));
var evoly=parseFloat(obj.y) + ((deplace) * Math.sin(angleHero));
...
h=h + 'left:0px;top:0px;width:50px;height:50px;z-index:' + nind + ';" ';
if(obj.contenu5!=''&&obj.contenu4==''){
h=h + ' onClick="' + obj.contenu5 + 'CObjets[' + obj.id + '].negnote=1;" ';
}
h=h + ' id="targetflux' + obj.idstr + '" class="targetflux' + obj.idstr + '" ';
...
h=h + '<table style="display:none;position:absolute;z-index:' + nind + ';color:' + color  + ';' + cur + '" ' ;
h=h + ' class="targetflux' + obj.idstr + '" ';
h=h + ' >';
h=h + '<tr><td id="targetfluxinner' + obj.id + '" ';
if(obj.contenu5!=''){
h=h + ' onMouseDown="' + obj.contenu5 + 'CObjets[' + obj.id + '].negnote=1;" ';
}
h=h + ' style="text-align:center;background-image:url(\'fx/transparent.png\');' + cur + ' color:' + color + ';" ';
h=h + ' unselectable="on" class="unselectable" >';
h=h + '</td></tr></table>';
}
Ecran.innerHTML=Ecran.innerHTML + h;
...
var ex=parseInt(obj.x * zoom);var ey=parseInt(obj.y * zoom);var wb=parseInt(obj.w * zoom);var hb=parseInt(obj.h * zoom);var lt_ex=ex - (wb/2);var lt_ey=ey - (hb/2);var tobjtarget=$(".targetflux" + obj.idstr);
...
var obj=CObjets[parseInt(i)];var ey=parseInt(obj.y * zoom);var hb=parseInt(obj.h * zoom);var lt_ey=ey - (hb/2);$(".targetflux" + obj.idstr).css("top",lt_ey + 'px');
}
...
var fluxitemstag23=0;var angleItems=0;try{angleItems=getAngle(obj.x,obj.y,obj.objx,obj.objy);
}catch(err){}
var dist=distancepyta(obj.objx,obj.objy,obj.x,obj.y);var deplace=parseInt(10);if(dist>10){
if(document.getElementById('targetflux' + obj.idstr)){
deplace =parseInt(obj.align);
var evolx=parseFloat(obj.x) + ((deplace) * Math.cos(angleItems));
var evoly=parseFloat(obj.y) + ((deplace) * Math.sin(angleItems));
var distcalcul=distancepyta(evolx,evoly,obj.x,obj.y);obj.x=evolx;
obj.y=evoly;
CObjets[obj.id].x=parseFloat(evolx);
CObjets[obj.id].y=parseFloat(evoly);
zoomfluxitems(i);
}
}else{
var evolx=parseFloat(obj.objx);var evoly=parseFloat(obj.objy);obj.x=evolx;
obj.y=evoly;
CObjets[obj.id].x=parseFloat(evolx);
CObjets[obj.id].y=parseFloat(evoly);
zoomfluxitems(i);
collideImageChange(obj.id,obj.x,obj.y);
times=10;
var parsedPoints=[];parsedPoints=obj.contenu2.split("!");
...
var xStart=parseInt(parsedStart[0]);var yStart=parseInt(parsedStart[1]);obj.x= parseInt(xStart);
obj.y= parseInt(yStart);
CObjets[obj.id].x=parseInt(xStart);
CObjets[obj.id].y=parseInt(yStart);
zoomfluxitems(i);
...
var ex=parseInt(obj.x);var ey=parseInt(obj.y);var ew=parseInt(obj.w);var eh=parseInt(obj.h);if(hx>ex&&hx<parseInt(ex+ew)){
if(hy>ey&&hy<parseInt(ey+eh)){
...
var rayonW=obj.w;var rayonH=obj.h;var evolx=parseFloat(obj.x) + ((rayonW) * Math.cos(obj.border));
var evoly=parseFloat(obj.y) + ((rayonH) * Math.sin(obj.border));
...
var nind=parseInt(obj.ind);var h='';var color="black";if(obj.color){color=obj.color;}
var Ecran=document.getElementById("main");var rn=Math.floor(Math.random() * 10000);obj.idstr=rn + '-' + obj.idscript ;
var ex=parseInt(obj.x * zoom);var ey=parseInt(obj.y * zoom);var wb=parseInt(obj.w * zoom);var hb=parseInt(obj.h * zoom);h=h + '<img style="position:absolute;';
h=h + 'left:' + ex + 'px;top:' + ey + 'px;width:' + wb + 'px;height:' + hb + 'px;z-index:' + nind + ';" ';
h=h + ' id="' + obj.contenu6 + 'targetMap' + obj.idstr + '" class="' + obj.contenu6 + 'targetMap' + obj.idstr + '" ';
...
var ex=parseInt(obj.x * zoom);var ey=parseInt(obj.y * zoom);var wb=parseInt(obj.w * zoom);var hb=parseInt(obj.h * zoom);var lt_ex=ex - (wb/2);var lt_ey=ey - (hb);var tobjtarget=$("." + obj.contenu6 + "targetMap" + obj.idstr);
tobjtarget.css("width",wb + 'px').css("height",hb + 'px');
tobjtarget.css("left",lt_ex + 'px').css("top",lt_ey + 'px');
}
}
...
var xanim=parseInt(parsedPt[0]);var yanim=parseInt(parsedPt[1]);obj.x=xanim;
obj.y=yanim;
obj.objx=xanim;
obj.objy=yanim;
var ex=parseInt(obj.x * zoom);var ey=parseInt(obj.y * zoom);var wb=parseInt(obj.w * zoom);var hb=parseInt(obj.h * zoom);var lt_ex=ex - (wb/2);var lt_ey=ey - (hb);InitialMapTarget[obj.contenu6]=ObjectifMapTarget[obj.contenu6];
objTarget.animate({
left: lt_ex + "px" ,
top:  lt_ey + "px"
}, 1000, function(){
...
if(obj.type=='maptarget'){
var objTarget=$("." + EquipMapTarg + "targetMap" + obj.idstr);
var times=50;var angleItems=0;try{angleItems=getAngle(obj.x,obj.y,obj.objx,obj.objy);
}catch(err){}
var dist=distancepyta(obj.objx,obj.objy,obj.x,obj.y);var deplace=parseInt(10);if(dist>10){//distance
if(document.getElementById(obj.contenu6 + 'targetMap' + obj.idstr)){
var deplace=parseInt(parseInt(obj.align));var evolx=parseFloat(obj.x) + ((deplace) * Math.cos(angleItems));
var evoly=parseFloat(obj.y) + ((deplace) * Math.sin(angleItems));
var distcalcul=distancepyta(evolx,evoly,obj.x,obj.y);obj.x=evolx;
obj.y=evoly;
CObjets[obj.id].x=parseInt(evolx);
CObjets[obj.id].y=parseInt(evoly);
zoomMapTarget(i);
}
}else{//distance
var evolx=parseFloat(obj.objx);var evoly=parseFloat(obj.objy);obj.x=evolx;
...
CObjets[obj.id].y=parseInt(evoly);
zoomMapTarget(i);
collideImageChangeMaptarget(obj.id,obj.x,obj.y);
times=1;
var parsedPoints=[];parsedPoints=obj.contenu2.split("!");
...
var Ecran=document.getElementById("main");var h='';h=h + '<img style="display:none;position:absolute;border:solid 1px gray;';
h=h + 'left:0px;top:0px;width:50px;height:50px;" ';
h=h + ' id="bloc' + obj.id + '" class="bloc' + obj.id + '" ';
h=h + ' src="images/' + obj.data +  '" ';
h=h + ' unselectable="on" class="unselectable" />';
Ecran.innerHTML=Ecran.innerHTML + h;
var ix=obj.x + (obj.w/2);
var iy=obj.y + (obj.h/2);
...
if(obj.evol==0){
var deplace=4;var angleItems=parseFlo(obj.text);var evolx=parseFloat(obj.x) + (deplace * Math.cos(angleItems));
var evoly=parseFloat(obj.y) + (deplace * Math.sin(angleItems));
if(evolx>980||evoly>740||evolx<-20||evoly<-20){
obj.evol=1;
}
obj.x=parseInt(evolx);
obj.y=parseInt(evoly);
CObjets[obj.id].x=parseInt(evolx);
CObjets[obj.id].y=parseInt(evoly);
...
if(obj.evol==2){
var deplace=4;var dist=distancepyta(obj.objx,obj.objy,obj.x,obj.y);if(dist>6){
var angleItems=parseFlo(getAngle(obj.x,obj.y,obj.objx,obj.objy));var evolx=parseFloat(obj.x) + (deplace * Math.cos(angleItems));
var evoly=parseFloat(obj.y) + (deplace * Math.sin(angleItems));
obj.x=parseInt(evolx);
obj.y=parseInt(evoly);
CObjets[obj.id].x=parseInt(evolx);
...
for(var i=0; i < CObjets_count; i++){
var obj=CObjets[i];if(obj.type=='simulItem'){
var ex=parseInt(obj.x * zoom);var ey=parseInt(obj.y * zoom);var wb=parseInt(obj.w * zoom);var hb=parseInt(obj.h * zoom);var lt_ex=ex - (wb/2);var lt_ey=ey - (hb/2);var tobjtarget=$(".simulItem" + obj.id);
tobjtarget.css("left",lt_ex + 'px').css("top",lt_ey + 'px');
tobjtarget.css("width",wb + 'px').css("height",hb + 'px');
}
}
...
h='<div class="bloc' + obj.id + '" style="background:gray;color:white;" >Error</div>'
}
if(h!=''){
...
h=h + ' data-rep="' + texteValue + '" ';
h=h + ' id="input' + obj.id + '" class="haveflou input' + obj.id + ' ' +  obj.idscript + '" ';
h=h + ' type="text" onKeyUp="execScriptLoop();eventCatchScript=true;" ';
if(obj.contenu5!=''){
...
var h='<div style="position:absolute;border:solid 1px black;cursor:text;background:white;" ';h=h + ' id="bloc' + obj.id + '" class="bloc' + obj.id + '" onKeyUp="execScriptLoop();eventCatchScript=true;" ';
h=h + ' >';
h=h + '</div>';
addToM(h);
...
h=h +  ' data-rep="' + obj.text + '" ';
h=h + ' id="input' + obj.id + '" class="haveflou bloc' + obj.id + ' ' +  obj.idscript + '" ';
h=h + ' type="text" ';
h=h + ' />';
addToM(h);
recupDataObjectMem(obj,lastPage0);
...
var h='<div style="position:absolute;border:solid 2px black;cursor:text;background:white;" ';h=h + ' id="bloc' + obj.id + '" class="bloc' + obj.id + '" ';
h=h + ' onClick="activeInputFocus(' + obj.id + ');" >';
h=h + '</div>';
h=h + '<input onkeypress="onKeyPressFocus(\'' + obj.id + '\')" onkeyUp="onKeyPressFocus(\'' + obj.id + '\')" ';
h=h + ' style="position:absolute;border:solid 2px #8A0808;z-index:10;display:none;" ';
h=h + ' data-rep="' + obj.text + '" ';
h=h + ' id="input' + obj.id + '" class="input' + obj.id + ' ' +  obj.idscript + ' inputfocus" ';
h=h + ' type="text" ';
h=h + ' />';
if(obj.field1!=''){
h=h + '<table style="position:absolute;border:solid 1px gray;z-index:10;background:white;;display:none;" ';
h=h + ' id="tableauto' + obj.id + '" class="table' + obj.id + '" ';
h=h + '>';
...
h=h + ' id="table' + obj.id + '" class="textarea haveflou bloc' + obj.id + '" ';
h=h +  ' data-rep="' + obj.text + '" ';
h=h + ' >';
h=h + '<tr><td>';
h=h + '<div id="divtextareabloc' + obj.id + '"  style="overflow:hidden;border:0px solid red;margin:1px;" >';
h=h +  '<textarea style="overflow:auto;" ';
h=h + ' id="textareabloc' + obj.id + '" class="textareabloc textareabloc' + obj.id + '" ';
h=h +  ' data-rep="' + obj.text + '" ';
h=h +  ' >';
h=h + '</textarea>';
h=h + '</div>';
...
var xb=parseInt(parseInt(obj.x - 2) * zoom);var yb=parseInt(parseInt(obj.y + 2) * zoom);
var hb=parseInt(obj.h * zoom);var wb=parseInt(parseInt(obj.w + 12) * zoom);
...
var IntervalClock =0;var clockId='';var clockAct='';var clockTimeI=20;var clockImage=1;function installclock(obj,act){
var h='';clockAct='';
IntervalClock=0;
var timeI=parseInt(obj.text);clockTimeI=timeI;
var timeG=parseInt(1000);var Ecran=document.getElementById("main");var randomnumber=Math.floor(Math.random()*10000);var randomnumber2=Math.floor(Math.random()*10000);var randomnumber3=Math.floor(Math.random()*10000);clockId='clocktimer' + obj.id + randomnumber + randomnumber2 + randomnumber3;
clockImage=1;
var decy='';if(obj.w<35||obj.an==18){
decy='margin-top:-1550px;';
clockImage=0;
}
h='<img style="display:none;' + decy + '" ';
h=h + ' id="bloc' + obj.id + '" class="' + clockId + ' bloc' + obj.id + '" ';
if(clockImage==1){
if(isGif(clockTimeI)==false){
h=h + ' src="fx/time/time0.png" ';
}else{
h=h + ' src="fx/time/timer' + clockTimeI + '.gif?ver=' + clockId + '" ';
}
}
h=h + ' />';
Ecran.innerHTML=Ecran.innerHTML + h;
...
setTimeout('animClock(' + timeG + ',"' + clockId + '")', timeG);
}
function svgaccept(){
...
function isGif(timeI){
if(timeI==5){return true;}
if(timeI==10){return true;}
if(timeI==15){return true;}
if(timeI==20){return true;}
if(timeI==25){return true;}
if(timeI==30){return true;}
if(timeI==35){return true;}
if(timeI==40){return true;}
if(timeI==45){return true;}
if(timeI==60){return true;}
if(timeI==90){return true;}
if(timeI==120){return true;}
return false;
}
...
if(clockImage==1){
if(isGif(clockTimeI)==false){
$("." + clockref).attr('src','fx/time/time' + IntervalClock + '.png');
}
}
...
$(".blocTimerCompteur").html('<b>' + MillisecondsToTimeForCompteur(globalCompteurTimerEnd) + '</b>');
...
chargeNoteObjectMem(dialogBloc,lastPage0,parseFlo(CDialogs[numid].note),parseFlo(repnote),numid,CDialogs[numid].remarque,'dialog');
if(parseFlo(CDialogs[numid].note)==parseFlo(repnote)){
var bhtml='<div class="blockbilan" ><div class="questbilan" ><span style="color:green;" >&#9632;&nbsp;</span> Dialogue</div>';bhtml=bhtml + '<ul>' + dialogQuest + '</ul>';
bhtml=bhtml + '<ul style="color:green;" ><i>&quot;' + libelle + '&quot;</i></ul>';
bhtml=bhtml + '</div>';
}else{
var bhtml='<div class="blockbilan" ><div class="questbilan" ><span style="color:orange;" >&#9632;&nbsp;</span> Dialogue</div>';bhtml=bhtml + '<ul>' + dialogQuest + '</ul>';
bhtml=bhtml + '<ul><i>&quot;' + libelle + '&quot;</i></ul>';
bhtml=bhtml + '</div>';
}
var bxml='<item id="' + idstr + '-' + numid + '" >';
bxml=bxml + "<answer>";
bxml=bxml + '<resume><![CDATA[' + dialogQuest + ']]></resume>';
bxml=bxml + "<text><![CDATA[" + libelle + "]]></text>";
bxml=bxml + "<note>" + parseInt(repnote) + "</note>";
bxml=bxml + "<total>" + noteReponse + "</total>";
bxml=bxml + "</answer>";
bxml=bxml + '</item>';
...
var rn=Math.floor(Math.random()*10000);var rn2=Math.floor(Math.random()*10000);var rn3=Math.floor(Math.random()*10000);obj.idstr=rn + rn2 + rn3;
h=h + '<img style="position:absolute;left:0px;top:0px;width:50px;height:50px;" ';
h=h + ' id="targetbloc' + obj.idstr + '" class="targetbloc' + obj.id + '" ';
h=h + ' src="images/' +  parsedIMG[0]  +  '" ';
h=h + act;
h=h + ' />';
Ecran.innerHTML=Ecran.innerHTML + h;
}
if(obj.type=='ludihiddenzone'){
h=h + '<span style="position:absolute;z-index:3;background-image:url(\'fx/transparent.png\');" ';
h=h + ' id="activebloc' + obj.id + '" class="zonebloc' + obj.id + '" ';
var escapedString=obj.text.replace(/'/g, " ").replace(/"/g, " ");h=h + ' onClick="$(\'#zonebloc' + obj.id + '\').fadeIn();hiddenZoneLastWord=\'' + escapedString + '\';" ';
h=h + '></span>';
h=h + '<img style="position:absolute;left:0px;top:0px;width:50px;height:50px;display:none;z-index:3;" ';
h=h + ' id="zonebloc' + obj.id + '" class="zonebloc' + obj.id + '" ';
h=h + ' src="' +   obj.src  +  '" ';
h=h + act;
h=h + ' />';
Ecran.innerHTML=Ecran.innerHTML + h;
...
h=h + '<span style="position:absolute;z-index:3;';
h=h + 'background-image:url(\'fx/transparent.png\');" ';
h=h + ' id="activebloc' + obj.id + '" class="zonebloc' + obj.id + '" ';
h=h + ' onClick="$(\'#zonebloc' + obj.id + '\').fadeIn();hzfakeincr();" ';
h=h + '></span>';
h=h + '<img style="position:absolute;left:0px;top:0px;width:50px;height:50px;display:none;z-index:3;" ';
h=h + ' id="zonebloc' + obj.id + '" class="zonebloc' + obj.id + '" ';
h=h + ' src="' +   obj.src  +  '" ';
...
h=h + ' id="cascade1bloc' + obj.idstr + '" class="cascadebloc' + obj.idstr + '" ';
h=h + ' src="' +   obj.src  +  '" ';
h=h + act;
h=h + ' />';
if(obj.de>0){
...
h=h + '<img style="position:absolute;left:0px;top:0px;width:50px;height:50px;display:none;z-index:2;" ';
h=h + ' id="cascade2bloc' + obj.idstr + '" class="cascadebloc' + obj.idstr + '" ';
h=h + ' src="' +   obj.src  +  '" ';
h=h + act;
h=h + ' />';
}
if(nb>2){
h=h +'<img style="position:absolute;left:0px;top:0px;width:50px;height:50px;display:none;z-index:2;" ';
h=h + ' id="cascade3bloc' + obj.idstr + '" class="cascadebloc' + obj.idstr + '" ';
h=h + ' src="' +   obj.src  +  '" ';
h=h + act;
h=h + ' />';
}
if(nb>3){
h=h +'<img style="position:absolute;left:0px;top:0px;width:50px;height:50px;display:none;z-index:2;" ';
h=h + ' id="cascade4bloc' + obj.idstr + '" class="cascadebloc' + obj.idstr + '" ';
h=h + ' src="' +   obj.src  +  '" ';
h=h + act;
h=h + ' />';
}
if(nb>4){
h=h +'<img style="position:absolute;left:0px;top:0px;width:50px;height:50px;display:none;z-index:2;" ';
h=h + ' id="cascade5bloc' + obj.idstr + '" class="cascadebloc' + obj.idstr + '" ';
h=h + ' src="' +   obj.src  +  '" ';
h=h + act;
h=h + ' />';
}
...
h=h + ' style="position:absolute;" ';
h=h + ' id="bloc' + obj.id + '" class="bloc' + obj.id + '" ';
h=h + '><tr><td id="innerbloclistemot' + obj.id + '" style="text-align:center;" >';
h=h + '<img src="css/ajax_loader_blue.gif" />';
h=h + '</td></tr></table>';
Ecran.innerHTML=Ecran.innerHTML + h;
}
if(obj.type=='ludirpt'){
...
h='<table ';
h=h + ' style="position:absolute;border:solid 0px purple;color:' + color + ';" ';
h=h + ' id="bloc' + obj.id + '" class="bloc' + obj.id + '" ';
h=h + '>';
...
h=h + '<tr><td class="libellegauge libelle' + obj.id + '" ';
h=h + ' style="color:' + color + ';" >';
h=h +  libelles[i] + '</td>';
h=h + '<td>';
h=h + '<div class="gauge' + obj.id + '" style="position:relative;" >';
h=h + '<div data-size="' + domainesPour[i] + '" class="barresty gaugebar' + obj.id + '" style="position:absolute;left:0px;top:0px;width:10px;overflow:hidden;';
h=h + 'background:' + rptcolors[i] + ';" >';
h=h + '<div class="notegauge" style="display:none;color:black;" >';
var resultD=Math.round(domainesN_F[i]*10)/10;h=h + resultD + '/' + domainesN_T[i];
h=h + '</div></div>';
h=h + '<img class="gauge' + obj.id + '" ';
h=h + ' style="position:absolute;left:0px;top:0px;width:' + wi + 'px;height:' + he + 'px;" src="fx/regle.png" />';
h=h + '</div>';
h=h + '</td></tr>';
}
}
...
h='<table ';
h=h + ' style="position:absolute;color:' + color + ';" ';
h=h + ' id="bloc' + obj.id + '" class="bloc' + obj.id + '" ';
h=h + '><tr><td id="innerbloctext' + obj.id + '" style="' + obj.css + '" >';
h=h + obj.text; //Html auto-g�n�r�
h=h + '</td></tr></table>';
Ecran.innerHTML=Ecran.innerHTML + h;
recupDataObjectMem(obj,lastPage0);
}
...
h=h + ' id="bloc' + obj.id + '" class="bloc' + obj.id + ' tcm' + obj.idscript + '" >';
h=h + '<tr><td id="innerbloctext' + obj.id + '" style="' + obj.css + '" >';
h=h + obj.text;
h=h + '</td></tr></table>';
Ecran.innerHTML=Ecran.innerHTML + h;
...
var obj=CObjets[i];var xb=parseInt(obj.x * zoom);var yb=parseInt(obj.y * zoom);var wb=parseInt(obj.w * zoom);var hb=parseInt(obj.h * zoom);if(document.getElementById("cascadeActivator" + obj.idstr)){
...
var xb=parseInt(obj.x * zoom);var yb=parseInt(obj.y * zoom);var wb=parseInt(obj.w * zoom);var hb=parseInt(obj.h * zoom);if(obj.type=='luditarget'){
...
if(parsedPoints[parseInt(obj.border)]!=''){
var parsedPt=[];parsedPt=parsedPoints[parseInt(obj.border)].split(";");
var wb=parseInt(obj.w/2);var hb=parseInt(obj.h/2);var xanim=parseInt(parseInt(parsedPt[0]) - wb) * zoom;var yanim=parseInt(parseInt(parsedPt[1]) - hb) * zoom;var timep=parseInt(parsedTime[parseInt(obj.border)]);$("#targetbloc" + obj.idstr).animate({
...
obj.border=parseInt(parseInt(obj.border) +1);
obj.x=parseInt(parsedPt[0]) - wb;
obj.y=parseInt(parsedPt[1]) - hb;
...
var xb=parseInt(obj.x * zoom);var yb=parseInt(obj.y * zoom);var wb=parseInt(obj.w/2);var hb=parseInt(obj.h/2);var xanim=parseInt(parseInt(parsedPoints[0]) - wb) * zoom;var yanim=parseInt(parseInt(parsedPoints[1]) - hb) * zoom;if(parseInt(obj.selectcolor)!=0){
...
var xObj=parseInt(obj.x * zoom);var yObj=parseInt(obj.y * zoom);var fontSizeObj=parseInt(obj.fontsize * zoom);var lgtObj=($('#innerbloc' + id + " p").length);
if(lgtObj>0){
...
if(textObj.length > 0){
var timeSteps=80;var next=textObj.match(/(\s*(<[^>]*>)?)*(&.*?;|.?)/)[0];textObj=textObj.substr(next.length);
...
var obj=CObjets[id];actualObjHW=id;
var xObj=parseInt(obj.x + ((obj.w/2)*0.2)) * zoom;
var yObj=parseInt(obj.y + ((obj.h/2)*0.9)) * zoom;
addHandWritingImg();
var sid=".bloc" + id +",.alterbloc" + id;
$(sid).css({opacity : 0});
$(sid).css("margin-top", "0px");
...
var obj=CObjets[id];var xObj=parseInt(obj.x + ((obj.w/2)*0.85)) * zoom;
var yObj=parseInt(obj.y + ((obj.h/2)*0.1)) * zoom;
var sid=".bloc" + id +",.alterbloc" + id;
if(actualObjHW==id){
$("#handpencil").animate({
"left" : parseInt(xObj) + "px",
...
var obj=CObjets[id];var xObj=parseInt(obj.x + ((obj.w)*0.90)) * zoom;
var yObj=parseInt(obj.y + ((obj.h/2)*0.6)) * zoom;
if(actualObjHW==id){
$("#handpencil").animate({
"left" : parseInt(xObj) + "px",
"top"  : parseInt(yObj) + "px"
...
var obj=CObjets[id];var xObj=parseInt(obj.x + ((obj.w)*0.75)) * zoom;
var yObj=parseInt(obj.y + ((obj.h)*0.82)) * zoom;
if(actualObjHW==id){
$("#handpencil").animate({
"left" : parseInt(xObj) + "px",
"top"  : parseInt(yObj) + "px"
...
var obj=CObjets[id];var xObj=parseInt(obj.x + ((obj.w)*0.16)) * zoom;
var yObj=parseInt(obj.y + ((obj.h)*0.75)) * zoom;
if(actualObjHW==id){
$("#handpencil").animate({
"left" : parseInt(xObj) + "px",
"top"  : parseInt(yObj) + "px"
...
var obj=CObjets[id];var xObj=parseInt(obj.x + ((obj.w)*0.16)) * zoom;
var yObj=parseInt(obj.y + ((obj.h)*0.17)) * zoom;
if(actualObjHW==id){
$("#handpencil").animate({
"left" : parseInt(xObj) + "px",
"top"  : parseInt(yObj) + "px"
...
function(){
$(".bloc" + id).attr("src","images/hand-circle4.png");
var cyObj=parseInt((obj.y + (obj.h/2)) * zoom);
$("#handpencil").animate({
"top"  : cyObj + "px"
},
300,
...
var decx=parseInt(parseInt(obj.w * zoom)/2);var decy=parseInt(parseInt(obj.h * zoom)/2);var ox=parseInt(obj.x * zoom) + decx;
var oy=parseInt(obj.y * zoom) + decy;
...
if(obj.w<65&&obj.h<65 ){
h=h + ' src="fx/cursor-minimal.gif" ';
}else{
if(obj.w>parseInt(obj.h * 3.8)){
h=h + ' src="fx/cursorlarge3.gif" ';
}else{
if(obj.w>parseInt(obj.h * 2.8)){
h=h + ' src="fx/cursorlarge2.gif" ';
}else{
if(obj.w>parseInt(obj.h * 1.8)){
...
if(obj.onmove!=1){
var xb=parseInt(obj.x * zoom) - 5;var yb=parseInt(obj.y * zoom) - 5;var wb=parseInt(obj.w * zoom) + 10 ;
var hb=parseInt(obj.h * zoom) + 10 ;
...
i=parseInt(i);
if(isPlacedDrag(i)){
CObjets[i].x=parseInt(CObjets[i].objx);
CObjets[i].y=parseInt(CObjets[i].objy);
attentePlace=0;
var nx=CObjets[i].x;var ny=CObjets[i].y;if(document.getElementById('table' + i)){
...
if(ViewerAfterBilan){return false;}
var nx=CObjets[j].x;var ny=CObjets[j].y;var nw=CObjets[j].w;var nh=CObjets[j].h;var dejaplace=false;for(var i=0; i < CObjets_count; i++){
CObjets[i].show_element();
if(CObjets[i].type=='drop'||CObjets[i].type=='bag'){
if(parseInt(CObjets[i].x)==parseInt(nx)){
if(parseInt(CObjets[i].y)==parseInt(ny)){
dejaplace=true;
}
}
if(parseInt(CObjets[i].x)==parseInt(nx)){
if(parseInt(ny)>parseInt(CObjets[i].y)){
var th=parseInt(parseInt(CObjets[i].y)+parseInt(CObjets[i].h));
if(parseInt(ny)<th){
dejaplace=true;
}
}
...
if(ViewerAfterBilan){return false;}
var nx=CObjets[j].x;var ny=CObjets[j].y;var dejaplace=false;for(var i=0; i < CObjets_count; i++){
if(j!=i){
...
var nx=CObjets[i].x;var ny=CObjets[i].y;CObjets[ObjDrag].x=nx;
CObjets[ObjDrag].y=ny;
if(type=='bag'){
if(isPlacedOnAnother(ObjDrag)){
ny=ny + CObjets[ObjDrag].h;
CObjets[ObjDrag].y=ny;
}
if(isPlacedOnAnother(ObjDrag)){
ny=ny + CObjets[ObjDrag].h;
...
VobjDrag.x=parseInt(VobjDrag.objx);
VobjDrag.y=parseInt(VobjDrag.objy);
var jnx=VobjDrag.x;var jny=VobjDrag.y;animplaceObj(ObjDrag,jnx,jny);
...
if(ObjDrag!=-1){
if(EcranDrag){
var i=parseInt(ObjDrag);var ex=parseInt(xcoord - EcranDragX) - parseInt(parseInt(CObjets[i].w * zoom)/2);if(CObjets[i].type=='dragslide'){
var x1=parseInt(ex / zoom);var x2=parseInt(CObjets[i].objx);if(x1 < x2){
ex=(CObjets[i].objx) * zoom;
CObjets[i].x=CObjets[i].objx;
}
var x3=parseInt(CObjets[i].text);if(x1 > (x2 + x3)){
ex=(CObjets[i].objx + x3) * zoom;
}
slideDragImage(parseInt(CObjets[i].x - x2), x3 , CObjets[i]);
}
...
CObjets[i].x=parseInt(ex / zoom);
var actiony=true;if(CObjets[i].type=='dragslide'){actiony=false;}
var ey=0;if(actiony){
ey=parseInt(ycoord - EcranDragY) - parseInt(parseInt(CObjets[i].h * zoom)/2);
if(document.getElementById('table' + i)){
...
CObjets[i].y=parseInt(ey / zoom);
}
if(CObjets[i].idscript=='ludiscapelinks'){
var decx=parseInt(parseInt(CObjets[i].w * zoom)/2);var decy=parseInt(parseInt(CObjets[i].h * zoom)/2);var lx=parseInt(CObjets[i].objx * zoom) + decx;
...
var ctrx=parseInt(objDrag.x + (objDrag.w / 2));
var ctry=parseInt(objDrag.y + (objDrag.h / 2));
for(var i=0; i < CObjets_count; i++){
if(CObjets[i].type=='drop'||CObjets[i].type=='bag'){
var r=0;if(ctrx>parseInt(CObjets[i].x)){
r=r + 1;
}
if(ctry>parseInt(CObjets[i].y)){
r=r + 1;
}
if(ctrx<parseInt(CObjets[i].x + CObjets[i].w)){
r=r + 1;
}
if(ctry<parseInt(CObjets[i].y + CObjets[i].h)){
r=r + 1;
}
if(r==4){
if(CObjets[i].type=='drop'){
var nx=CObjets[i].x + (CObjets[i].w / 2) - (CObjets[j].w / 2);
CObjets[j].x=nx;
var ny=CObjets[i].y + (CObjets[i].h / 2) - (CObjets[j].h / 2);
CObjets[j].y=ny;
placeObj(j,nx,ny);
}else{
if(CObjets[i].w<=parseInt(CObjets[j].w+10)){
if(CObjets[i].h<=parseInt(CObjets[j].h+10)){
var nx=CObjets[i].x + (CObjets[i].w / 2) - (CObjets[j].w / 2);
CObjets[j].x=nx;
var ny=CObjets[i].y + (CObjets[i].h / 2) - (CObjets[j].h / 2);
CObjets[j].y=ny;
...
if(objDrag.option==1){
CObjets[j].x=parseInt(CObjets[j].objx);
CObjets[j].y=parseInt(CObjets[j].objy);
var jnx=CObjets[j].x;var jny=CObjets[j].y;animplaceObj(j,jnx,jny);
...
if(ObjTouchDrag!=-1){
TouchDistant=TouchDistant + 1;
var ex=parseInt(dragdropTX - Ecran.offsetLeft) - parseInt(parseInt(CObjets[ObjTouchDrag].w * zoom)/2);var ey=parseInt(dragdropTY - Ecran.offsetTop) - parseInt(parseInt(CObjets[ObjTouchDrag].h * zoom)/2);if(CObjets[ObjTouchDrag].type=='dragslide'){
var x1=parseInt(ex / zoom);var x2=parseInt(CObjets[ObjTouchDrag].objx);if(x1 < x2){
ex=(CObjets[ObjTouchDrag].objx) * zoom;
CObjets[ObjTouchDrag].x=CObjets[ObjTouchDrag].objx;
}
var x3=parseInt(CObjets[ObjTouchDrag].text);if(x1 > (x2 + x3)){
ex=(CObjets[ObjTouchDrag].objx + x3) * zoom;
}
slideDragImage(parseInt(CObjets[ObjTouchDrag].x - x2), x3 , CObjets[ObjTouchDrag]);
}
document.getElementById('table' + ObjTouchDrag).style.left=ex + 'px';
$("#imgbloc" + ObjTouchDrag).css("left",parseInt(ex - 5) + 'px');
CObjets[ObjTouchDrag].x=ex / zoom;
if(CObjets[ObjTouchDrag].type=='drag'){
document.getElementById('table' + ObjTouchDrag).style.top=ey + 'px';
CObjets[ObjTouchDrag].y=ey / zoom;
$("#imgbloc" + ObjTouchDrag).css("top", parseInt(ey - 5) + 'px');
if(CObjets[ObjTouchDrag].idscript=='ludiscapelinks'){
var decx=parseInt(parseInt(CObjets[ObjTouchDrag].w * zoom)/2);var decy=parseInt(parseInt(CObjets[ObjTouchDrag].h * zoom)/2);var lx=parseInt(CObjets[ObjTouchDrag].objx * zoom) + decx;
...
if(CObjets[i].x>bordx&&CObjets[i].x<bordxmax){
...
var playAudPGlobal;function playAudP(audObject){
if(globalSound==0){
...
var e_x=parseInt(obj.x * zoom);var e_y=parseInt(obj.y * zoom);var wb=parseInt(obj.w * zoom);var hb=parseInt(obj.h * zoom);$(".blocload" + obj.id).css("top", parseInt(e_y) + 'px').css("left", parseInt(e_x) + 'px');
...
var h='<img style="display:none;" ';h=h + ' id="bloc' + obj.id + '" class="bloc' + obj.id + '" ';
h=h + ' src="data/' + obj.src + '" ';
h=h + ' />';
Ecran.innerHTML=Ecran.innerHTML + h;
}
}
...
if(this.id==pagid){
var css3=recupCss3();memimagepreload=memimagepreload + imagefondLoad + ';';
if(css3){
$('#main').css("background-image", "url('" + imagefondLoad + "')");
...
||colorfond.indexOf(".gif")!=-1
||colorfond.indexOf(".jpeg")!=-1){
if(!document.getElementById("colorfond")){
var h='';if(Ecran){
if(colorfond.indexOf("repeat:")!=-1){
var backfond=colorfond.replace('repeat:','');h='<div style="display:none;opacity:1;position:absolute;z-index:0;';
h=h + 'left:0px;top:0px;background:url(\'' + backfond + '\') 0 0;" ';
h=h + ' id="colorfond" class="colorfond" ';
h=h + ' class="unselectable" unselectable="on" ></div>';
...
var objMain=$('#main');var lowImage=finalfond.replace('images/','images/low-').replace('.png','.jpg');if(finalfond.indexOf("fond-white.png")!=-1||memimagepreload.indexOf(finalfond)!=-1){
lowImage=finalfond;
}
h=h +  '<div style="display:none;position:absolute;';
h=h + 'left:0px;top:0px;background-image:url(\'' + lowImage + '\');background-size:100% 100%;background-repeat:no-repeat;background-position:0 0;background-color:transparent;" ';
h=h + ' id="colorfond" class="colorfond" ';
h=h + ' class="unselectable" unselectable="on" ></div>';
...
var lowImage=finalfond.replace('images/','images/low-').replace('.png','.jpg');if(finalfond.indexOf("fond-white.png")!=-1||memimagepreload.indexOf(finalfond)!=-1){
lowImage=finalfond;
}
h=h +  '<img style="display:none;position:absolute;left:0px;top:0px;opacity:1;z-index:0;" ';
h=h + ' id="colorfond" class="colorfond" ';
h=h + ' src="' + lowImage + '" ';
h=h + '  class="unselectable" unselectable="on" />';
imagefondglobal=finalfond;
}
if(finalfond.indexOf("fond-white.png")==-1||memimagepreload.indexOf(finalfond)==-1){
var hdPreload='if(lastPage0==' + lastPage0 + '){loadFullHdImg(' + lastPage0 + ');}';
setTimeout(hdPreload,200);
}
if(colorfond.indexOf("fond-white.png")!=-1){
...
if(h!=""){
addToM(h);
var fdcol=$("#colorfond");fdcol.css("width", $("#main").width() + 'px');
...
if(Ecran){
if(Ecran.style.backgroundColor!=colorfond&&colorfond!=""){
try{Ecran.style.backgroundColor=colorfond;
}catch(err){
...
var finalfond=colorfond.replace('large:','');var img1=finalfond.replace('/','/LARG1');if(document.getElementById("larg1")){
...
var remarques='';var MessageFalse='';var colorfond="";var largefondx="";var largefondy="";var cadrefond="";var cadrecolorfond="";var cadrebordercolorfond="";var headerfond="";var headercolorfond="";var headerbordercolorfond="";var footerfond="";var footercolorfond="";var footerbordercolorfond="";var acceptMoveObj=1;var exceptionForkDragDrop=false;var scriptdiapo="";var scriptloop="";var lastPage1=0;var lastPage0=0;var nbpagesD=1;var tirageunique=0;var saveprogression=false;var saveprogressionident='';var scormProcessScore=0;var saveprogressionident='';var attemptProcess=0;var domainesliste='';var parametersapp='';function CObjet(){
...
var e_y=parseInt(this.y * zoom);var wb=parseInt(this.w * zoom);var hb=parseInt(this.h * zoom);var posisty="left:" + e_x + ";top:" + e_y + ";width:" + wb + ";height:" + hb + ";";
if(this.an==1){
posisty="";
}
...
h=h + ' id="table' + this.id + '" class="bloc' + this.id + '"  >';
h=h + '<div class="scrollbar" ><div class="track"><div class="thumb"><div class="end"></div></div></div></div>';
h=h + '<div class="viewport" id="viewport' + this.id + '" ><div id="overview' + this.id + '"  class="overview">';
h=h + '<p>' + this.text + '</p>';
h=h + '</div></div></div>';
haveNoSyntaxInScreen=false;
}
...
var wb=parseInt(this.w * zoom);var hb=parseInt(this.h * zoom);var larg=parseInt(parseInt(this.fontsize * 1.5) * zoom);$('.bloc' + this.id).hideWords({
large: larg ,
words: this.text ,
width: wb,
height: hb
...
var sid=".bloc" + obj.id;
var Tobj=$(sid);var wb=parseInt(obj.w * zoom);var hb=parseInt(obj.h * zoom);var ctrx=parseInt(obj.realx);if(ctrx!=e_x){
if(acceptMoveObj==1){
...
Iobj.css("font-size",parseInt(obj.fontsize * zoom) + 'px');
}
if(obj.type=='inputFocus'){
var Iobj=$(".input"+ obj.id);
...
$("#textareabloc" + obj.id).css("font-size",parseInt(obj.fontsize * zoom) + 'px');
}
if(obj.type=='timercompteur'){
$(".blocTimerCompteur"  + obj.id).css("font-size",parseInt(obj.fontsize * zoom) + 'px');
...
if(obj.align!='Fit'){
Tobj.css("font-size",parseInt(obj.fontsize * zoom) + 'px');
}else{
...
if(obj.type=='drop'){
Tobjdrop.css("left",parseInt(obj.x * zoom) + 'px');
Tobjdrop.css("top",parseInt(obj.y * zoom) + 'px');
Tobjdrop.css("width",parseInt(obj.w * zoom) + 'px');
Tobjdrop.css("height",parseInt(obj.h * zoom) + 'px');
}
if(obj.type=='bag'){
if(parseInt(obj.w * zoom)<120&&parseInt(obj.w * zoom)<120){
Tobjdrop.css("left",parseInt(obj.x * zoom) + 'px');
Tobjdrop.css("top",parseInt(obj.y * zoom) + 'px');
Tobjdrop.css("width" , parseInt(obj.w * zoom) + 'px');
Tobjdrop.css("height", parseInt(obj.h * zoom) + 'px');
}else{
var bagW=parseInt(parseInt(obj.w * zoom) - 120)/2;var bagH=parseInt(parseInt(obj.w * zoom) - 120)/2;Tobjdrop.css("left", parseInt(parseInt(obj.x * zoom) + bagW) + 'px');
Tobjdrop.css("top" , parseInt(parseInt(obj.y * zoom) + bagW) + 'px');
...
tempBloc.pp=parseInt($(this).find('pp').text());
...
tempBloc.contenu2=$(this).find('contenu2').text();
tempBloc.contenu3=$(this).find('contenu3').text();
tempBloc.contenu4=$(this).find('contenu4').text();
tempBloc.contenu5=$(this).find('contenu5').text();
tempBloc.contenu6=$(this).find('contenu6').text();
tempBloc.contenu7=$(this).find('contenu7').text();
tempBloc.contenu8=$(this).find('contenu8').text();
...
if(transitionPage=='Flip'){
$( "#main" ).addClass("main3dtransi");
$( "#main" ).removeClass("main3d");
$('#main').animate({
opacity : 0.75
}, 20, function(){
$( "#main" ).removeClass("main3dtransi");
$( "#main" ).addClass("main3dtransi2");
$('#main').animate({
opacity : 1
}, 250, function(){
$( "#main" ).removeClass("main3dtransi2");
$( "#main" ).addClass("main3dno");
});
});
}
if(IOS==0){
...
var memimagepreload="";function preLoadImgPage(i){
if(i>1000){
return false;
}
...
if(tempBoite=="bbullewhite"||tempBoite=="clouding"){
var tempSrc4=$(this).find('contenu4').text();var imgLoadProcess4=new Image();imgLoadProcess4.onload=function(){};
imgLoadProcess4.src=tempSrc4;
}
...
setTimeout(function(){preLoadImgPage(i+1);}, 2000);
}
}else{
preLoadImgPage(i+1);
}
...
if(transitionPage=='Flip'){
if(haveCss3D()){
$( "body" ).addClass("body3d");
$( "#main" ).addClass("main3d");
$( "#main" ).removeClass("main3dno");
setTimeout(function(){loadFile(f);}, 600);
}else{
$('#main').animate({
opacity : 0.1
}, 500, function(){
...
$('#globalcurtainanim').css("opacity" , "1");
$('#globalcurtainanim2').css("left",'98%').css("top",'0px').css("width", '2%');
...
h += "<div class='supprightmessage' onClick='stopdispRightMess()' ></div>";
...
var stateHtml="";function recupMainStateHtml(){
stateHtml= $("#main").html();
}
...
$("#main").append(h);
$("#ecranalter").css("position","absolute").css("right","0px").css("top","0px");
var backColor= $("#main").css("background-color");var widthDec=$("#main").width() + "px";
$("#ecranalter").css("width",widthDec);
$("#ecranalter").css("height",$("#main").height() + "px");
$("#ecranalter").css("z-index","4");
$("#ecranalter").css("background-color",backColor);
stateHtml=stateHtml.replace(/id="/g,'id="ecranalter');
stateHtml=stateHtml.replace(/bloc/g,'blocalter');
stateHtml=stateHtml.replace(/onClick/g,'data-onclick');
$("#ecranalter").append(stateHtml);
$("#ecranalter").find(".noslideobject").remove();
$("#ecranalter2").css("position","absolute").css("right","-" + widthDec);
$("#ecranalter2").css("top","0px").css("background-color","white");
$("#ecranalter2").css("width",widthDec);
$("#ecranalter2").css("height",$("#main").height() + "px");
...
var stateHtml2= $("#main").html();stateHtml2=stateHtml2.replace('ecranalter2','ecranalter3');
stateHtml2=stateHtml2.replace(/id="/g,'id="ecransecond');
stateHtml2=stateHtml2.replace(/bloc/g,'blocsecondr');
stateHtml2=stateHtml2.replace(/onClick/g,'data-onclick');
$("#ecranalter2").append(stateHtml2);
setTimeout(function(){
$("#ecranalter2").find(".dataexptclass").remove();
$("#ecranalter2").find(".noslideobject").remove();
if(leftSld){
$('.ecranalter').animate({
"right" : '-' + widthDec
},500,function(){
...
var obj=CObjetMems[i];x=x + obj.getInteractions();
}
x=x + '<ViewerAfterBilan>' + ViewerAfterBilan + '</ViewerAfterBilan>';
x=x + '<lastPageMemId>' + lastPage0 + '</lastPageMemId>';
x=x + '<ViewerAfterBilanList>' + ViewerAfterBilanList + '</ViewerAfterBilanList>';
x=x + '<initExam>' + initExam + '</initExam>';
x=x + '<actualExamId>' + actualExamId + '</actualExamId>';
x=x + '<actualExamIdScreen>' + actualExamIdScreen + '</actualExamIdScreen>';
x=x + '<lastExamId>' + lastExamId + '</lastExamId>';
x=x + '<lastAfterExamId>' + lastAfterExamId + '</lastAfterExamId>';
x=x + '<qcmRandomize>' + qcmRandomize + '</qcmRandomize>';
x=x + '<LUDIlife>' + LUDIlife + '</LUDIlife>';
x=x + '<LUDImoney>' + LUDImoney + '</LUDImoney>';
x=x + '<LUDIscore>' + LUDIscore + '</LUDIscore>';
if(Variable1!=''){
...
var Ecran=document.getElementById("main");var title= 'Sauvegarde : ' + dt  + '<br />Voulez-vous reprendre ?';
var inn='<p class="dialogDownTitle" >' + title + '</p>';
inn=inn + '<p><a class="buttonDialogDownNo" href="javascript:closeYNProgressionAll();" >Non</a>&nbsp;';
inn=inn + '<a class="buttonDialogDownYes" href="javascript:loadProgressionAllRestauration();" >Oui</a></p>';
...
var h=getBoite(obj);if(obj.boite==''){
h=getBoite(obj);
}
var srctemp=obj.src;if(obj.contenu7!=''){
if(isSVGcompatible()){
...
if(obj.field2!=''){
h=h + '<div style="position:absolute;background:' + obj.field2 + ';z-index:1;' + cssv + '" ';
h=h + ' class="imgbloc' + obj.id + ' alterbloc' + obj.id + '" ';
h=h + ' ></div>';
}
...
onmo=onmo + ' onMouseLeave="$(\'#bloc' + obj.id  + '\').attr(\'src\',\'' + srctemp + '\');" ';
}
h=h + '<img ';
h=h + ' id="bloc' + obj.id + '" class="haveflou unselectable bloc' + obj.id + ' ' +  obj.idscript + '" ';
h=h + ' src="' + srctemp + '" ';
...
h=h + ' id="table' + obj.id + '" class="bloc' + obj.id + '" ';
h=h + ' >';
h=h + '<tr><td style="border-bottom:solid 2px ' + color + ';text-align:center;" >';
h=h + mynote;
h=h + '</td></tr>';
h=h + '<tr><td style="text-align:center;" >';
if(obj.option==1){
h=h + N_T;
}else{
h=h + '20';
...
h=h + '<div id="com_valid" style="display:none;" >OK</div>';
if(obj.data!=''){
setTimeout(obj.data, 1000);
}
resultSuccess=true;
}else{
h=h + '<div id="com_valid" style="display:none;" >KO</div>';
if(obj.src!=''){
...
h=h + '<img style="display:none;' +  obj.cssadd + '" ';
h=h + ' id="bloc' + obj.id + '" class="bloc' + obj.id + '" ';
h=h + ' src="' + im + '" ';
h=h + ' />';
h=h + '<div id="com_note" style="display:none;" >' + mynote + '</div>';
}
Ecran.innerHTML=Ecran.innerHTML + h;
}
...
h=h + ' id="table' + obj.id + '" class="bloc' + obj.id + '" ';
h=h + ' >';
h=h + '<tr><td style="' + alignByObj(obj) + cssPlus + obj.cssadd + '" >';
h=h + remarques;
h=h + '</td></tr></table>';
Ecran.innerHTML=Ecran.innerHTML + h;
}
...
obj.objx=myPour;
obj.border=false;
h=h + '<img style="' +  obj.cssadd + '" ';
h=h + ' id="bloc' + obj.id + '" class="bloc' + obj.id + '" ';
h=h + ' src="images/progress-bar-fond.png" ';
h=h + ' />';
h=h + '<div style="position:absolute;background:#ACFA58;width:2px;' +  obj.cssadd + '" ';
h=h + ' id="bloc-progress' + obj.id + '" class="bloc-progress' + obj.id + '" ';
h=h + ' ></div>';
h=h + '<img style="position:absolute;" ';
h=h + ' id="bloc-mask' + obj.id + '" class="bloc-mask' + obj.id + '" ';
h=h + ' src="images/progress-bar-mask.png" ';
h=h + ' />';
h=h + '<table style="position:absolute;color:' + color + ';" ';
h=h + ' id="table' + obj.id + '" >';
h=h + '<tr><td id="table-inner' + obj.id + '" ';
h=h + ' style="text-align:right;font-family:Lucida Bright;" >';
h=h + '<b>' + myPour+ '%' + '</b>';
h=h + '</td></tr>';
h=h + '</table>';
Ecran.innerHTML=Ecran.innerHTML + h;
...
if(obj.type=='finalprogressbar'){
var xb=parseInt((obj.x + 15) * zoom);
var yb=parseInt((obj.y + 13) * zoom);
...
bilansource=bilansource + '<ul>';
var h='<table style="display:none;color:' + color + ';' +  obj.cssadd + '" ';
...
var caseHtml='<td class="qcmcoche qcmcoche' + obj.id + '" style="cursor:pointer;text-align:center;" >';
...
rq.v=namerep;
StockRepQ.push(rq);
caseHtml=caseHtml + '<tr><td id="' + tdid + '" name="' + idRep + '" class="' + checkclass + ' ' +  randomname + classm + '" ';
if(obj.option3==1){
...
if(obj.contenu8==0){
h=h + '<td class="selectqcmline" style="text-align:left;padding-left:10px;" ';
}else{
h=h + '<td class="selectqcmline" style="text-align:right;padding-right:10px;" ';
}
if(actionmini!=''){
...
h=h + ' id="table' + obj.id + '" class="bloc' + obj.id + '"  ><tr>';
h=h + '<td style="padding:0;margin:0;" >';
var tdid=obj.id + 'qcmunique';
h=h + '<table class="qcmt cochecase cochecase' + obj.id + '" ' ;
h=h + ' style="color:' + color + ';width:20px;height:20px;';
if(obj.boite==''){
h=h + 'border:solid 1px ' + color + ';" >';
}else{
h=h + '" >';
}
...
h=h + '<tr><td id="' + tdid + '" ';
h=h + ' name="' + checkclass + '" ';
h=h + ' class="' + randomname + '" ';
if(obj.boite==''){
h=h + ' style="padding:0;margin:0;text-align:center;cursor:pointer;background:white;"  ';
h=h + ' onclick="makecheckedUnik(this,\'' + randomname + '\');" >';
}else{
h=h + ' style="padding:0;margin:0;text-align:center;cursor:pointer;background:transparent;"  ';
h=h + ' >';
}
h=h +'';
h=h +'</td></tr></table>';
if(obj.boite!=''){
h=h + '<img src="fx/qcm/' + obj.boite + '0.png" class="cocheimg img' +  randomname + ' cocheimg' + obj.id + '" ';
h=h + ' style="color:' + color + ';width:10px;height:10px;cursor:pointer;" ';
h=h + ' onclick="makecheckedimgUnik(this,\'' + tdid + '\',\'' + randomname + '\',\'' + obj.boite + '\');" />';
}
h=h +'</td></tr></table>';
Ecran.innerHTML=Ecran.innerHTML + h;
recupDataObjectMem(obj,lastPage0);
...
if(obj.type=='qcmunique'){
var largqcm=parseInt(obj.h * zoom);var tid=".cochecase" + obj.id;
...
var h='<div style="left:50px;top:150px;width:450px;height:400px;" ';h=h + 'class="ludiSortableListSortable bloc' + obj.id + '"  >';
h=h + '<div><div data-force="5" ></div></div>';
h=h + '<div data-force="5" ';
h=h + 'class="ludiSortableListSortableUl" style="margin-right:2%;" >';
h=h + '<div>&nbsp;</div>';
h=h + '<ul id="advancedA-' + obj.id + '" class="ludiSortableUl" >';
h=h + recomposeMotsaRelier(obj.contenu2);
h=h + '</ul>';
h=h + '</div>';
h=h + '<div data-force="5" class="ludiSortableListSortableUl2" >';
h=h + '<div style="text-align:center;color:gray;" >' + obj.contenu7 + '</div>';
h=h + '<ul id="advancedB-' + obj.id + '" class="ludiSortableUl" >';
h=h + '</ul>';
h=h + '</div>';
...
var obj=CObjets[i];var wb=parseInt(obj.w * zoom);var hb=parseInt(obj.h * zoom);var ftreal=parseInt($("#fit" + obj.id).attr("data-ftsize"));
...
h=h + ' id="table' + obj.id + '" ';
h=h + 'class="table' + obj.id + ' ' + obj.idscript + ' ' + obj.boite + ' alterbloc' + obj.id + '" ';
h=h + ' >';
var boit=obj.boite.replace("box","");h=h + '<div id="roundblue' + obj.id + '" class="' + boit + '" >';
var boitText=obj.boite.replace("box","text");h=h + '<div id="roundbluetext' + obj.id + '" class="' + boitText + '" >';
h=h + obj.text;
h=h + '</div></div></div>';
addToM(h);
}
...
var h='<div ' + act;
h=h + ' id="roundboutongray' + obj.id + '" ';
h=h + 'class="roundboutongray alterbloc' + obj.id + '" >';
h=h + '<a id="roundboutongrayinner' + obj.id + '" ';
if(obj.w<80){
h=h + 'class="roundboutonbef5" >';
}else{
h=h + 'class="roundboutonbef10" >';
}
h=h + '<div id="roundboutongrayicon' + obj.id + '" class="roundboutongrayicon ' + obj.idscript  + '" ></div>';
h=h + '</a></div>';
addToM(h);
...
h=h +	'class="LargegrayPanel" >';
h=h + '<a onClick="actPbshow(' + obj.id + ');" id="LargegrayPanelInner' + obj.id + '" class="LargegrayPanelInner" style="color:' + color + ';" >';
h=h + obj.text + '&nbsp;&#9207;';
h=h + '</a>';
h=h + '<a onClick="actPbshow(' + obj.id + ');" id="LargegrayPanelBottom' + obj.id + '" style="display:none;" class="LargegrayPanelBottom" ></a>';
h=h + '<div id="LargegrayPanelText' + obj.id + '" style="display:none;" ';
h=h + ' class="LargegrayPanelText" >';
h=h + obj.contenu2 + '<br/><br/>';
h=h + '</div></div>';
addToM(h);
}
if(obj.type=='panelslide'){
var sens='Right';if(obj.x<20){
sens='Left';
}
var h='<div id="LargePanelSide' + obj.id + '" ';
h=h + ' class="LargePanelSide' + sens + ' LPanelSide" ';
h=h + ' onClick="actPanelSide' + sens + '(' + obj.id + ');" >';
h=h + '<div id="PanelSideVerticalText' + obj.id + '" ';
h=h + ' class="LargePanelSideVerticalText" ';
h=h + ' style="background-image:url(images/' + obj.contenu3 + ');" ';
h=h + '></div>';
h=h + '</div>';
h=h + '<div id="LargePanelSideInner' + obj.id + '" ';
h=h + ' class="LargePanelSideInner' + sens + ' PanelSideInner" >';
h=h + '<div class="PanelSideCross" ';
h=h + ' onClick="actPanelSide' + sens + '(' + obj.id + ');" >';
h=h + '&#215;</div>';
h=h + obj.contenu2;
h=h + '</div>';
...
h=h + ' onClick="actPclinkCenter (' + obj.id + ');" >';
h=h + '<div class="p1"></div><div class="p2"></div>';
h=h + '<div class="p3"></div><div class="p4"></div></div>';
if(obj.x>largEcranWidth-320){
if(obj.y>(largEcranHeight-320)){
...
h=h + '<div id="PanelCenterInner' + obj.id + '" class="PanelCenterInner" >';
h=h + '<div class="PanelSideCross" ';
h=h + ' onClick="closePclinkCenter();" >';
h=h + '&#215;</div>';
h=h + obj.contenu2;
h=h + '</div>';
addToM(h);
...
h=h + ' class="topludimenu bloc' + obj.id + '" ';
h=h + ' onClick="actShowNavLudiMenu(' + obj.id + ');" >';
h=h + '</a>';
h=h + ' <ul id="navludimenu' + obj.id + '" class="navludimenu" >';
h=h + obj.text;
h=h + ' </ul>';
addToM(h);
}
...
h=h + ' class="blockmenu bloc' + obj.id + '" >';
h=h + '<a onclick="LUDI.goPage('+ eachdiap[0] +');"><li>';
h=h + '<img class="blockmenualignleft" ';
h=h + 'src="css/icons/' + eachico[0] + '" />';
h=h + eachtxt[0];
h=h + '</li></a>';
h=h + '<a onclick="LUDI.goPage('+ eachdiap[1] +');"><li>';
h=h + '<img class="blockmenualignleft" ';
h=h + 'src="css/icons/' + eachico[1] + '" />';
h=h + eachtxt[1];
h=h + '</li></a>';
h=h + '<a onclick="LUDI.goPage('+ eachdiap[2] +');"><li>';
h=h + '<img class="blockmenualignleft" ';
h=h + 'src="css/icons/' + eachico[2] + '" />';
h=h + eachtxt[2];
h=h + '</li></a>';
h=h + '<a onclick="LUDI.goPage('+ eachdiap[3] +');"><li>';
h=h + '<img class="blockmenualignleft" ';
h=h + 'src="css/icons/' + eachico[3] + '" />';
h=h + eachtxt[3];
h=h + '</li></a>';
h=h + '</ul>';
$("#main").append(h);
...
if(obj.type=='boitetexte'){
var xb=parseInt(obj.x * zoom);var yb=parseInt(obj.y * zoom);var wb=parseInt(obj.w * zoom) - 20;var hb=parseInt(obj.h * zoom) - 20;var tb=$(".table" + obj.id);
tb.css("left",xb + 'px');
tb.css("top" ,yb + 'px');
tb.css("width",wb + 'px');
tb.css("height",hb + 'px');
...
var xb=parseInt(obj.x * zoom);var yb=parseInt(obj.y * zoom);var tb=$("#roundboutongray" + obj.id);
tb.css("left",xb + 'px');
tb.css("top" ,yb + 'px');
tb.css("z-index" ,obj.ind);
var marginR=parseInt(10);if(obj.w<80){
marginR=5;
}
var wb=parseInt(obj.w * zoom) - ( marginR + marginR + 3);
var hb=parseInt(obj.h * zoom) - ( marginR + marginR + 3);
...
if(obj.type=='panelboxshow'){
var xb=parseInt(obj.x * zoom);var yb=parseInt(obj.y * zoom);var wb=parseInt(obj.w * zoom) + 5;
var hb=parseInt(obj.h * zoom);var tb=$("#LargegrayPanel" + obj.id);
tb.css("left",xb + 'px');
tb.css("top" ,yb + 'px');
tb.css("width",wb + 'px');
tb.css("height" ,hb + 'px');
...
if(obj.type=='panelslide'){
var yb=parseInt(obj.y * zoom);var hb=parseInt(obj.h * zoom);var tb=$("#LargePanelSide" + obj.id);
tb.css("top" ,yb + 'px');
tb.css("height" ,hb + 'px');
...
if(obj.type=='panelcenter'){
var xb=parseInt(obj.x * zoom)-25;var yb=parseInt(obj.y * zoom)-25;var tb=$("#LPanelC" + obj.id);
tb.css("left" ,xb + 'px');
tb.css("top" ,yb + 'px');
var pcl=$("#PanelCenterLink" + obj.id);
if(obj.x>largEcranWidth-320){
if(obj.y>(largEcranHeight-320)){
xb=parseInt(obj.x * zoom)-175;
yb=parseInt(obj.y * zoom)-175;
pcl.css("left" ,xb + 'px');
pcl.css("top" ,yb + 'px');
xb=parseInt(obj.x * zoom) - 400;
yb=parseInt(obj.y * zoom) - 400;
}else{
xb=parseInt(obj.x * zoom)-175;
yb=parseInt(obj.y * zoom)-25;
pcl.css("left" ,xb + 'px');
pcl.css("top" ,yb + 'px');
xb=parseInt(obj.x * zoom) - 400;
yb=parseInt(obj.y * zoom) + 100;
}
}else{
if(obj.y>(largEcranHeight-320)){
xb=parseInt(obj.x * zoom)-25;
yb=parseInt(obj.y * zoom)-175;
pcl.css("left" ,xb + 'px');
pcl.css("top" ,yb + 'px');
xb=parseInt(obj.x * zoom) + 100;
yb=parseInt(obj.y * zoom) - 400;
}else{
pcl.css("left" ,xb + 'px');
pcl.css("top" ,yb + 'px');
...
var xb=parseInt(obj.x * zoom);var yb=parseInt(obj.y * zoom) + parseInt(obj.h * zoom) + 10;
if(obj.x<largEcranWidth/2){
xb=parseInt(obj.x * zoom);
tb.css("left",xb + "px");
}else{
xb=parseInt((largEcranWidth-(obj.x+obj.w))*zoom);
tb.css("right",xb + "px");
}
if(obj.y<largEcranHeight/2){
yb=parseInt(obj.y * zoom) + parseInt(obj.h * zoom) + 10;
tb.css("top",yb + "px");
}else{
yb=parseInt((largEcranHeight - obj.y)*zoom) + 10;
tb.css("bottom",yb + "px");
}
}
if(obj.type=='menuludiblock'){
...
obj.y=obj.objy;
if(obj.y>(largEcranHeight-380)){
obj.y=largEcranHeight-380;
}
var yb=parseInt(obj.y * zoom);var hb=parseInt(375 * zoom);ctrOb.animate({
top: yb + "px",
height: hb + "px"
},500, function(){
});
...
obj.y=obj.objy;
var yb=parseInt(obj.y * zoom);var hb=parseInt(obj.h * zoom);ctrOb.removeClass("LargegrayPanelOpen");
ctrOb.animate({
top: yb + "px",
height: hb + "px"
},500, function(){
...
var mr=ctrOb.css('marginLeft');if(mr=="400px"){
ctrOb.animate({
marginLeft: "0px"
},500, function(){
});
...
var ctrOb=$("#LargePanelSide" + i + ",#LargePanelSideInner" + i);
var mr=ctrOb.css('marginRight');if(mr=="400px"){
ctrOb.animate({
marginRight: "0px"
},500, function(){
});
...
h=h + ' id="bloc' + obj.id + '" class="haveflou unselectable bloc' + obj.id + ' ' +  obj.idscript + '" ';
h=h + ' src="' + obj.data + '" ';
h=h + ' style="display:none;' + posisty + '" ';
h=h + ' />';
try
{
if(N_T!=0&&N_F!=0){
...
h=h + '<img ';
h=h + ' id="starA' + obj.id + '" class="unselectable" ';
h=h + ' src="' + obj.text + '" ';
h=h + ' style="position:absolute;z-index:4;" />';
h=h + '<img ';
h=h + ' id="starB' + obj.id + '" class="unselectable" ';
h=h + ' src="' + obj.contenu2 + '" ';
h=h + ' style="position:absolute;z-index:4;" />';
h=h + '<img ';
h=h + ' id="starC' + obj.id + '" class="unselectable" ';
h=h + ' src="' + obj.contenu3 + '" ';
h=h + ' style="position:absolute;z-index:4;" />';
h=h + '<img ';
h=h + ' id="starD' + obj.id + '" class="unselectable" ';
h=h + ' src="data/starts.gif" ';
h=h + ' style="position:absolute;z-index:5;display:none;" />';
Ecran.innerHTML=Ecran.innerHTML + h;
zoomshowStart(obj);
setTimeout(function(){zoomshowA(obj.id);},1000);
}
function zoomshowStart(obj){
var dec=765;var xb=parseInt((obj.x - (4 + dec)) * zoom);
var yb=parseInt((obj.y + 27 - dec) * zoom);
...
var xbB=parseInt((obj.x + 120) * zoom);
var ybB=parseInt((obj.y - (50 + dec)) * zoom);
...
var xbC=parseInt((obj.x + 303 + dec) * zoom);
var ybC=parseInt((obj.y + 27 - dec ) * zoom);
...
var xb=parseInt((obj.x - 4) * zoom);var yb=parseInt((obj.y + 27) * zoom);
var wb=parseInt(155 * zoom);var hb=parseInt(155 * zoom);$("#starA" + obj.id).css("width",wb + 'px').css("height",hb + 'px');
$("#starA" + obj.id).css("left",xb + 'px').css("top",yb + 'px');
var xbB=parseInt((obj.x + 148) * zoom);
var ybB=parseInt((obj.y - 2) * zoom);var wbB=parseInt(160 * zoom);var hbB=parseInt(146 * zoom);$("#starB" + obj.id).css("width",wbB + 'px').css("height",hbB + 'px');
$("#starB" + obj.id).css("left",xbB + 'px').css("top",ybB + 'px');
var xbC=parseInt((obj.x + 303) * zoom);
var ybC=parseInt((obj.y + 27) * zoom);
...
playshow();
obj=CObjets[i];
var xb=parseInt((obj.x + 148) * zoom);
var yb=parseInt((obj.y - 2) * zoom);var wb=parseInt(160 * zoom);var hb=parseInt(146 * zoom);var objstar=$("#starB" + obj.id);
objstar.animate({
left: xb + "px",
top: yb + "px",
width: wb + "px",
...
playshow();
obj=CObjets[i];
var xb=parseInt((obj.x + 303) * zoom);
var yb=parseInt((obj.y + 27) * zoom);
...
var xbC=parseInt((obj.x + 330) * zoom);
var ybC=parseInt((obj.y + 25) * zoom);
...
if(Oty=='bag'){
var objBag=CObjets[i];var nbelementsbag=0;for(var j=0; j < CObjets_count; j++){
if(CObjets[j].type=='drag'){
var objDrag=CObjets[j];var ctrx=parseInt(objDrag.x + (objDrag.w / 2));
var ctry=parseInt(objDrag.y + (objDrag.h / 2));
if(isOnBag(objDrag)){
}else{
if(objDrag.data==objBag.data){
if(ctrx<parseInt(objBag.x)){
r=false;
minLog='bag';
}
if(ctry<parseInt(objBag.y)){
r=false;
minLog='bag';
}
if(ctrx>parseInt(objBag.x + objBag.w)){
r=false;
minLog='bag';
}
if(ctry>parseInt(objBag.y + objBag.h)){
r=false;
minLog='bag';
}
}
...
var r=false;var ctrx=parseInt(objDrag.x + (objDrag.w / 2));
var ctry=parseInt(objDrag.y + (objDrag.h / 2));
for(var j=0; j < CObjets_count; j++){
...
Xanswers=Xanswers + StockRepQ[wrongA] + ';';
...
var reponseA=$(this).attr('name');CObjetCorrectAnswer=CObjetCorrectAnswer + StockRepQ[reponseA] + ',';
if($(this).html()!="X"){
r=false;
}else{
Xanswers=Xanswers + StockRepQ[reponseA] + ';';
if(CObjets[i].option3==1){
noteSpe += parseFlo($(this).attr('data-note'));
}
}
...
if(Oty=='drop'){
var objDrag=findObjByIdStr(CObjets[i].data);var ctrx=parseInt(objDrag.x + (objDrag.w / 2));
var ctry=parseInt(objDrag.y + (objDrag.h / 2));
...
var Ecran=document.getElementById("main");var libelles=obj.text.split('|');var rptcolors=obj.data.split(';');var h='<div style="position:absolute;" ';h=h + ' id="bloc' + obj.id + '" class="bloc' + obj.id + '" ';
h=h + '>';
h=h + '<div style="border-bottom:solid 1px gray;position:absolute;z-index:3;overflow:hidden;" ';
h=h + ' id="blocbarre' + obj.id + '" class="blocbarre' + obj.id + '" ';
h=h + '>';
h=h + '<div class="rptColHorizon" >100%</div>';
h=h + '<div class="rptColHorizon" >80%</div>';
h=h + '<div class="rptColHorizon" >60%</div>';
h=h + '<div class="rptColHorizon" >40%</div>';
h=h + '<div class="rptColHorizon" >20%</div>';
h=h + obj.contenu2;
h=h + '</div>';
h=h + '<img style="position:absolute;bottom:0px;left:0px;z-index:1;" id="imgbarre' + obj.id + '" class="imgbarre' + obj.id + '"  src="images/LibellesDomaines.png" />';
h=h + '</div>';
Ecran.innerHTML=Ecran.innerHTML + h;
...
var hb=parseInt(parseInt(obj.h -85) * zoom);var wb=parseInt(obj.w * zoom);$(".blocbarre" + obj.id).css("height" , hb + 'px');
...
h=h + 'border-right:solid 1px gray;border-left:solid 1px gray;overflow:hidden;" ';
h=h + ' id="bloc' + obj.id + '" class="bloc' + obj.id + '" ';
h=h + ' />';
obj.idstr="";
...
h= h + '<div id="page" class="SlideContainPage' + obj.id + '" ';
h= h + ' style="background-color:white;position:absolute;left:0px;top:0px;" ';
h= h + ' >' ;
obj.idstr="";
...
h= h + '<div id="' + pageid + '" class="parentPage' + obj.id + '" ';
h= h + ' style="background-color:white;float:left;position:relative" >';
h= h + loadReponsesslide;
h= h + '</div>';
...
h= h + '</div>';
h=h + '</div>';
h=h + '<div onClick="slideMoveRight(\'' + obj.id + '\')" id="slidebtnr' + obj.id + '" ';
h=h + ' class="btnslideright" style="display:none;" ></div>';
h=h + '<div onClick="slideMoveLeft(\'' + obj.id + '\')" id="slidebtnl' + obj.id + '" ';
h=h + ' class="btnslideleft" style="display:none;" ></div>';
...
var ex=parseInt(obj.x * zoom);var ey=parseInt(obj.y * zoom);var ew=parseInt(obj.w * zoom);var eh=parseInt(obj.h * zoom);$(".parentPage" + obj.id).css("width",ew + 'px').css("height",eh + 'px');
...
if(obj.AnimClic==0){
setTimeoutLudi(condi + obj.fctanim + condistop, obj.de);
}
}
if(obj.an==3){
...
setTimeoutLudi(condi + fctanim + condistop, obj.de + obj.dedi + 500);
}else{
var fctanim='$(\'' + sid + '\').css({opacity : 0}).css("margin-top","-100px");';
setTimeoutLudi(condi + fctanim + condistop, obj.de + obj.dedi + 300);
}
}
}
...
setTimeoutLudi(fctanim, CObjets[i].de);
}
}
}else{
...
if(j!=-1){
setTimeoutLudi(CObjets[j].fctanim, CObjets[j].de);
...
if(obj.linkx!=''){
var nx=parseInt(recupDataLink(obj.linkx,obj.x));obj.x=nx;
}
if(obj.linky!=''){
obj.y=parseInt(recupDataLink(obj.linky,obj.y));
}
}
...
iesin=Math.sin(rad);
halfWidth=(obj.w * zoom)/2;
halfHeight=(obj.h * zoom)/2;
...
var ml=$(sid).width() - parseInt(obj.w * zoom);ml=ml / 2;
var hl=$(sid).height() - parseInt(obj.h * zoom);hl=hl / 2;
...
var srctemp=obj.contenu2;var h='<img ';h=h + ' id="bloc' + obj.id + '" class="unselectable bloc' + obj.id + '" ';
h=h + ' src="' + srctemp + '" ';
h=h + ' style="cursor:pointer;display:none;' + obj.cssadd + '" ';
h=h + act;
h=h + ' />';
...
var srctemp=obj.contenu2;var h='<img ';h=h + ' id="bloc' + obj.id + '" class="unselectable bloc' + obj.id + '" ';
h=h + ' onMouseOver="upBilan(' +  obj.id + ');" ';
h=h + ' onMouseOut="doBilan(' +  obj.id + ');" ';
h=h + ' src="' + srctemp + '" ';
h=h + ' style="cursor:pointer;display:none;' + obj.cssadd + '" ';
h=h + act;
h=h + ' />';
...
h=h + '<div id="bilanresult" class="mainbilan" >';
h=h + '<div onClick="stopBilanResult()" id="closelightbox" class="closelightbox" ></div>';
h=h + '<div id="toptitleH" class="toptitle" >' + obj.contenu3 + '</div>';
h=h + '<img class="printBilan" onClick="PrintElem(\'containBilanH\');" src="fx/printbtn.png" />';
h=h + '<div id="containBilanH" class="containBilan" >' + replaceIdStockQ(fullBilanResult,false) + '</div>';
h=h + '</div>';
}
Ecran.innerHTML=Ecran.innerHTML + h;
if('function' == typeof(SetXapiEnd)){
...
var fct="sendBilanMail(" + mynote + ",'" + obj.field1 + "','" + obj.contenu7 + "'," + obj.contenu8 + ")";
setTimeout(fct, 3000);
}
if(obj.contenu5!=''){
...
function upBilan(i){
var wb=parseInt(CObjets[i].w * zoom);var hb=parseInt(CObjets[i].h * zoom);var wb_max=parseInt(wb * 1.1);var hb_max=parseInt(hb * 1.1);var dec_x=parseInt((wb_max - wb) / 2 );var dec_y=parseInt((hb_max - hb) / 2 );/*$('.bloc' + i).css("width",wb_max + 'px').css("height",hb_max + 'px');
$('.bloc' + i).css("margin-left", '-' + dec_x + 'px').css( "margin-top" , '-' + dec_y + 'px');*/
...
function doBilan(i){
var wb=parseInt(CObjets[i].w * zoom);var hb=parseInt(CObjets[i].h * zoom);$('.bloc' + i).stop().animate({width : wb + 'px',height : hb + 'px',marginLeft : '0px',marginTop : '0px' } , 300);
}
...
var mywindow;if(navigator.userAgent.toUpperCase().indexOf("MSIE") != -1){
...
h=h + '<div style="display:none;position:absolute;overflow:hidden;" ';
h=h + ' class="bloc' + obj.id + '" unselectable="on" >';
var widthvideo=parseInt(obj.w * zoom);var heightvideo=parseInt(obj.h * zoom);if(parseInt(obj.border)!=0){
...
if(obj.type=='videodistante'){
h=h + '<div style="display:none;position:absolute;background:black;overflow: hidden;" ';
h=h + ' class="bloc' + obj.id + '" unselectable="on" >';
var widthvideo=parseInt(obj.w * zoom) + 4;
var heightvideo=parseInt(obj.h * zoom) + 4;
...
var Ecran=document.getElementById("main");var h='';var leftvideo=parseInt(obj.x * zoom);var topvideo=parseInt(obj.y * zoom);var widthvideo=parseInt(obj.w * zoom);var heightvideo=parseInt(obj.h * zoom);if(parseInt(obj.border)!=0){
var b= parseInt(parseInt(parseInt(parseInt(obj.border) * -1) * 2) * zoom);widthvideo =widthvideo  + b;
heightvideo=heightvideo + b;
}
h=h + '<div class="videoContainer bloc' + obj.id + '" style="left:' + leftvideo + 'px;top:' + topvideo + 'px;" >';
var ident=LUDI.guid();if(obj.idscript!=''){
ident=obj.idscript;
}
...
if(obj.type=='audiomultihtml'){
var xb=parseInt(obj.x * zoom);var yb=parseInt(obj.y * zoom);var wb=parseInt(obj.w * zoom);var hb=parseInt(obj.h * zoom);$('.bloclist' + obj.id).css("left",xb + 'px').css("top",parseInt(yb + hb) + 'px').css("width",wb + 'px');
}
}
...
var Ecran=document.getElementById("main");var h='';h=h + '<table style="color:' + color + ';" ';
h=h + ' id="table' + obj.id + '" unselectable="on" ';
h=h + ' class="haveflou unselectable bloc' + obj.id + ' ' +  obj.idscript + '" ';
h=h + ' >';
h=h + '<tr>';
h=h + '<td id="innerbloc' + obj.id + '" style="text-align:left;vertical-align:top;' + obj.cssadd + cssPlus + '" class="unselectable ' +  obj.idscript + 'inner" unselectable="on" >';
h=h + "<div class='reportw' id='tablescrool" + obj.id + "' style='width:100%;height:200px;overflow:auto;' >";
h=h + "</div>"
h=h + '</td></tr></table>';
...
Ecran.innerHTML=Ecran.innerHTML + h;
if(obj.field1!=''){
loadReportWrite(obj.data,"tablescrool" + obj.id,obj.field1);
}else{
loadReportWrite(obj.data,"tablescrool" + obj.id,'');
}
}
}
function loadReportWrite(data,id,mkript){
var d=new Date();var n=d.getMinutes();$.ajax({
type: "GET",
url: 'data/' + data + '?t=' + n,
dataType: (isMsie()) ? "text" : "xml",
...
setTimeout(function(){sendRapportWMail(RapportWmkript)}, 1000);
}
}
,
error: function(){
...
if(typeO==4){
textAdd=textAdd.replace('{comments}', getBilanReportW());
hfull=hfull + textAdd;
}
}
});
...
var mywindow;if(navigator.userAgent.toUpperCase().indexOf("MSIE") != -1){
mywindow=window.open("", 'Print', 'height=200,width=200')
}else{
mywindow=window.open("", 'Print', 'height=200,width=200');
}
...
var extenLgProcess='.php';function sendBilanMail(mynote,mkript,objm,history){
if(haveRightSendMail()){
var titleh2=getInfosSuppBilanLearnerName();title2=titleh2 + getInfosSuppBilanWrite();
...
$.ajax({
type: "GET",
url: 'data/sendlinkbilan.php?u=' + FullEmail + '&p=' + learnerName + '&b=' + bil,
dataType: "text",
...
logBilan("Impossible d'envoyer le bilan !");
}
},
error: function(){
logBilan("Impossible d'envoyer le bilan !");
...
type: 'GET',
url: urlp + "?t=" + t + "&m=" + nsend + '&i=' + idg + '&e=1',
dataType: "jsonp",
cache:false,
success:function(json){
logBilan("success !");
...
function sendRapportWMail(mkript){
if(haveRightSendMail()){
...
function sendAlterRapportWMail(mkript){
if(SendRapportBool==0){
var msend=netbalises(textSendRapportW);msend=netH(msend);
var titleh2=getInfosSuppBilanLearnerName();msend=titleh2 + msend;
SendRapportBool=1;
var urlp='http://www.batisseurs-numeriques.fr/ludiscapesendresultsplease/exreport.php';$.ajax({
type: 'GET',
url: urlp + "?t=" + mkript + "&m=" + msend,
dataType: "jsonp",
cache:false,
success:function(data){
logBilan("Message is send GET");
return true;
},
complete: function(){
logBilan( "AJAX GET - complete()" );
...
logBilan(jqXHR.status);
if(jqXHR.status != 200){
crossDomainPostLudi(urlp,mkript,msend);
}
}
});
}
...
var Ecran=document.getElementById("main");var h='<div ';h=h + 'style="position:absolute;';
h=h + 'cursor:text;text-align:center;z-index:3;" ';
h=h + ' id="bloc' + obj.id + '" class="bloc' + obj.id + ' exambarre" ';
h=h + ' >';
h=h + obj.text;
h=h + '</div>';
if(obj.option==1){
if(obj.y>300){
h=h + '<div id="showScreen" style="position:absolute;display:none;z-index:4;" class="examscreen_box_bottom" >';
}else{
h=h + '<div id="showScreen" style="position:absolute;display:none;z-index:4;" class="examscreen_box" >';
}
h=h + '<img id="showScreenimg" class="showScreenimg" onMouseLeave="hiddenDataScreen();" onClick="processDataScreenExamIdScreen();"  '
h=h + 'style="position:relative;display:none;';
h=h + 'cursor:pointer;z-index:4;" ';
h=h + '  />';
h=h + '</div>';
}
Ecran.innerHTML=Ecran.innerHTML + h;
...
collDiapoExam[i]='1';
var nbr=parseInt(Math.random() * nb);for(var j=0;j<200;j++){
nbr=parseInt(Math.random()*(nb));
...
var nb=parseInt(document.getElementById("DiapoNbDiapo").innerHTML);if(actualExamId!=-1){
...
var posi=$('.exambarre').position();var largLink=(obj.offsetWidth + 6) * parseInt(i-1);
...
var ctrx=parseInt(CObjets[j].x)-18;var ctry=parseInt(CObjets[j].y)-5;var idAnim=i * 1000;var h="<div id='idAnim" + idAnim + "' ";
h=h + " style='position : absolute;left:" + convertToPercentX(ctrx) + ";top:" + convertToPercentY(ctry) + ";' ";
h=h + " class='goodMarkDiv' >&#10003;</div>"
$("#main").append(h);
var rx=parseInt(CObjets[j].x)-6;var ry=parseInt(CObjets[j].y)-6;var rw=parseInt(CObjets[j].w)+9;
var rh=parseInt(CObjets[j].h)+9;
...
var VobjDrag=findObjByIdStr(CObjets[i].data);var ctrx=parseInt(VobjDrag.x + (VobjDrag.w / 2));
var ctry=parseInt(VobjDrag.y + (VobjDrag.h / 2));
var r=true;if(ctrx<parseInt(CObjets[i].x)){
r=false;
}
if(ctry<parseInt(CObjets[i].y)){
r=false;
...
if(r==false){
VobjDrag.x=parseInt(CObjets[i].x);
VobjDrag.y=parseInt(CObjets[i].y);
var jnx=VobjDrag.x;var jny=VobjDrag.y;animplaceObj(VobjDrag.id,jnx,jny);
...
var ctrx=parseInt(VobjDrag.x + (VobjDrag.w / 2));
var ctry=parseInt(VobjDrag.y + (VobjDrag.h / 2));
var r=true;if(ctrx<parseInt(CObjets[j].x)){
r=false;
}
if(ctry<parseInt(CObjets[j].y)){
r=false;
}
if(ctrx>parseInt(CObjets[j].x + CObjets[j].w)){
r=false;
}
if(ctry>parseInt(CObjets[j].y + CObjets[j].h)){
r=false;
}
if(r==false){
$('#table' + VobjDrag.id).css("color","red");
}
VobjDrag.x=parseInt(CObjets[j].x);
VobjDrag.y=parseInt(CObjets[j].y);
progx=parseInt(parseInt(CObjets[j].w - VobjDrag.w) / 2);
var jnx=VobjDrag.x + progx;
var jny=VobjDrag.y + progy;
animplaceObj(VobjDrag.id,jnx,jny);
progy=progy + VobjDrag.h;
$('#table' + VobjDrag.id).attr('onMouseDown','').unbind('MouseDown');
$('#imgbloc' + VobjDrag.id).attr('onMouseDown','').unbind('MouseDown');
}
...
var ctrx=parseInt(VobjDrag.x + (VobjDrag.w / 2));
var ctry=parseInt(VobjDrag.y + (VobjDrag.h / 2));
var r=false;if(ctrx>parseInt(CObjets[j].x)){
if(ctry>parseInt(CObjets[j].y)){
if(ctrx<parseInt(CObjets[j].x + CObjets[j].w)){
if(ctry<parseInt(CObjets[j].y + CObjets[j].h)){
r=true;
...
var ctrx=parseInt(parseInt(CObjets[i].x + (CObjets[i].w/2)) * zoom);
var ctry=parseInt(CObjets[i].y * zoom);var cl='tooltipsgreen';if(Sit(rep)!=Sit(yrep)||yrep==''){
cl='tooltipsred';
}else{
displayrep="&#x2714;";
}
var h='<a style="left:' + ctrx + 'px;top:' + ctry + 'px;" ';
h=h + ' class="' + cl + '" href="#">.<span>' + displayrep + '</span></a>';
$("#main").append(h);
}
...
var displayrep="";var ctrx=parseInt(parseInt(CObjets[i].x + (CObjets[i].w/2)) * zoom);
var ctry=parseInt(CObjets[i].y * zoom);var cl='tooltipsgreen';if(!r){
cl='tooltipsred';
displayrep="&#x2717;";
...
if($(tdunik).html()=="X"){
var ctrx=parseInt(CObjets[j].x * zoom)-18;var ctry=parseInt(CObjets[j].y * zoom)-5;var idAnim=i * 100;var h="<div id='idAnim" + idAnim + "' ";
...
var rep=$('.input' + CObjets[i].id ).attr('data-rep');
var displayrep=rep;var yrep=document.getElementById('input' + CObjets[i].id).value;
var ctrx=parseInt(CObjets[i].x)-18;var ctry=parseInt(CObjets[i].y * zoom)-5;if(Sit(rep)!=Sit(yrep)||yrep==''){
...
h=h + " style='left:0px;top:0px;' ";
h=h + " class='suiviErreurMark errorMark' >&#x2717;</span>"
$(this).prepend(h);
}
});
}
...
h=h + ' id="boule' + obj.id + '" ';
h=h + ' class="unselectable boule' + obj.id + '" ';
h=h + ' src="' + obj.text + '" ';
h=h + ' style="display:none;z-index:1;position:absolute;' + obj.cssadd + '" ';
h=h + ' />';
tempBoule.x=obj.x + (obj.w/2) ;
tempBoule.y=obj.y + (obj.h/2) ;
...
h=h + ' class="unselectable bloc' + obj.id + '" ';
h=h + ' src="' + obj.data + '" ';
h=h + ' style="display:none;' + obj.cssadd + '" ';
h=h + ' />';
haveCanon=true;
Ecran.innerHTML=Ecran.innerHTML + h;
...
for(var i=0; i < CObjets_count; i++){
if(CObjets[i].type=='physicscanon'){
var Vobj= CObjets[i];var Ecran=document.getElementById("main");var ex=parseInt(parseInt(xcoord - Ecran.offsetLeft) /zoom);var ey=parseInt(parseInt(ycoord - Ecran.offsetTop ) /zoom);var angleCanon=getAngle(ex,ey,Vobj.x + (Vobj.w/2) ,Vobj.y + (Vobj.h/2));
...
var LUDIlife=0;var LUDIlifegameover=0;var LUDIlifeheight=0;var LUDIlifeTotal=0;var LUDImoney=0;var LUDIscore=0;var LUDIspeed=15;var LUDIwait=0;var LUDIactualID="";var LUDIfuturID="";var LUDIrunScript=true;var LUDIrunPage=true;var LUDIactivePopUp=0;var LUDIrunPageIsOk=false;var LUDIactualPageIsOk=false;var runGameOver=false;var runOneLife=false;function ludiscape(){
...
var Vobj= CObjets[i];Vobj.x=x;
Vobj.y=y;
var ex=parseInt(Vobj.x * zoom);var ey=parseInt(Vobj.y * zoom);$(".bloc" + Vobj.id).css("left",ex + 'px').css("top",ey + 'px');
zoomBoite(Vobj);
zoomBoiteTexte(Vobj);
}
}
...
Vobj.w=Vobj2.w;
Vobj.h=Vobj2.h;
var ex=parseInt(Vobj.x * zoom);var ey=parseInt(Vobj.y * zoom);var ew=parseInt(Vobj.w * zoom);var eh=parseInt(Vobj.h * zoom);$(".bloc" + Vobj.id).css("left",ex + 'px').css("top",ey + 'px');
...
var angleLUDI=0;try{angleLUDI=getAngle(obj.x,obj.y,obj.objx,obj.objy);
}catch(err){}
var dist=distancepyta(obj.objx,obj.objy,obj.x,obj.y);var deplace=parseInt(LUDIspeed * zoom);if(dist>LUDIspeed){
var evolx=parseFloat(obj.x) +  ((deplace) * Math.cos(angleLUDI));
var evoly=parseFloat(obj.y) + ((deplace) * Math.sin(angleLUDI));
obj.x=evolx;
obj.y=evoly;
var ex=parseInt(obj.x * zoom);var ey=parseInt(obj.y * zoom);$(".bloc" + obj.id).css("left",ex + 'px').css("top",ey + 'px');
zoomBoite(obj);
if(LUDIrunScript){
...
var Ecran=document.getElementById("main");var hm='<div class="lexiqueContent" style="overflow:hidden;" >';hm=hm + '<p class="lexiqueTitle" >' + lexiqueObject.term + '</p>';
hm=hm + '<p>' + lexiqueObject.resume + '</p>';
hm=hm + '</div>';
hm=hm + '<a class="addLexique" onClick="ShowLexiqueLarg();" ></a>';
hm=hm + '<a class="delLexique" onClick="$(\'#lexiqueBox\').fadeOut()" ></a>';
if(!document.getElementById("lexiqueBox")){
var h='<div id="lexiqueBox" class="lexiqueBox" >';h=h + hm;
h=h + '</div>';
$("#main").append(h);
}else{
$("#lexiqueBox").empty();
...
var hm='<div class="lexiqueContentLarg" style="overflow:auto;" >';hm=hm + '<p>' + lexiqueObject.detail + '</p>';
hm=hm + '</div>';
hm=hm + '<a class="delLexique" onClick="$(\'#lexiqueBox\').fadeOut()" ></a>';
if(lexiquePosY<parseInt((largEcranHeight *zoom)/2)){
...
var h='<div id="parametreOpac" onClick="closePara()" ></div>';h=h + '<div id="parametrebox" >';
h=h + '<div id="parametreinner" >';
h=h + innerParametres() + '</div></div>';
$("#main").append(h);
}
...
var h='<h1>PARAMETRES</h1>';h=h + '<table style="" ><tbody>';
h=h + '<tr>';
h=h + '<td style="cursor: pointer; text-align: center; width:36px; height:36px;">';
h=h + '<div style="position:relative;z-index:0;width:36px;height:36px;" >';
h=h + '<img onClick="checkMusic();" class="imgMusic" src="fx/qcm/check' + globalMusic + '.png" ';
h=h + ' style="width:36px;height:36px;cursor:pointer;" />';
h=h + '</div>';
h=h + '</td>';
h=h + '<td onClick="checkMusic();" class="selectqcmline" style="text-align:left;padding-left:10px;" >';
h=h + 'Musique</td>';
h=h + '</tr>';
h=h + '<tr>';
h=h + '<td style="cursor: pointer; text-align: center; width:36px; height:36px;">';
h=h + '<div style="position:relative;z-index:0;width:36px;height:36px;" >';
h=h + '<img onClick="checkSound();" class="imgSound"  src="fx/qcm/check' + globalSound + '.png" ';
h=h + ' style="width:36px;height:36px;cursor:pointer;" />';
h=h + '</div>';
h=h + '</td>';
h=h + '<td onClick="checkSound();" class="selectqcmline" style="text-align:left;padding-left:10px;" >';
h=h + 'Effets Audio</td>';
h=h + '</tr>';
h=h + '</tbody></table>';
return h;
...
var login='';ludiscapeFinishActivity(login,activityId,title,success,duration,score_raw);
}
}
}
...
var login=getLoginNameUnik();if('function' == typeof(ludiscapeFinishAll)){
...
var login=getLoginNameUnik();var pageId=parseInt(lastPage1);if('function' == typeof(ludiscapeFinishScreen)){
...
var idscript=parseTxt(obj.idscript);var description=parseTxt(obj.idscript);ScormInteractionCom(n,idscript,parseTxt(obj.type),duration,result,parseTxt(answer),description,parseTxt(correctAnswer));
